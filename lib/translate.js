...
const translate = (input) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const translateCachePath = path_1.default.join(config_1.default.output, config_1.default.translateCacheFileName);
    let translateCacheData = {};
    try {
        const stat = fs_1.default.statSync(translateCachePath);
        if (stat.isFile()) {
            translateCacheData =
                JSON.parse(fs_1.default.readFileSync(translateCachePath, "utf-8").toString()) ||
                    {};
        }
    }
    catch (err) { }
    ...
    fs_1.default.writeFileSync(translateCachePath, JSON.stringify(translateCacheData, null, 2));
