...
const createDefinitions = (definitionsFile, data, option) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // 翻译所有的中文名称
    const result = translate ? yield (0, translate_1.translate)(names) : names;
    // 所有的定义名称修正
