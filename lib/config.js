...
exports.translateCacheFileName = void 0;
...
const apiMap = Object.keys(platformMap)
    ...
    .reduce((prev, next) => (Object.assign(Object.assign({}, prev), next)), {});
exports.translateCacheFileName = "translateCache.json";
const output = path_1.default.join(process.cwd(), "./openapi");
const defaultConfig = {
    translateCache: path_1.default.join(output, exports.translateCacheFileName),
