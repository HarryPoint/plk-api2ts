...
// add source files
project.addSourceFilesAtPaths("types/**/*.ts");
const definitionsFile = project.createSourceFile("types/definitions.ts", "", {
  overwrite: true,
});

await createDefinitions(definitionsFile, data, { translate: false });
