...
/**
* @author lin.he
* @link http://47.108.139.107:17600/doc.html#/default/消息方案/stagingUsingPOST_1
*/
export default function fetchMethod(options: { data: IMessageSchemaStagingRequestDTO }, extraOptions?: any) {
    return http<IJSONResultlong>(
        {
            url: "/message-notification-service/messageSchema/staging",
            method: "POST",
            ...options,
        },
        extraOptions,
...
export interface ISmsTemplateDTO {
    ...
    id?: string;
    /** 审核状态 */
    auditStatus?: ESmsTemplateDTO_auditStatus;
    /** 失败原因 */
    failReason?: string;
    /** 模板名称 */
    templateName?: string;
    ...
    formConfigId?: string;
    /** 是否使用配置 */
    isUseConfig?: ESmsTemplateDTO_isUseConfig;
    /** 字段元数据 */
    fieldMetaList?: IMessageContentFieldMetaDTO[];
}
/** JSONResult«long» */
...
export enum ESmsTemplateDTO_auditStatus {
    /** 未审核 */
    NONE = "NONE",
    /** 审核中 */
...
export enum ESmsTemplateDTO_isUseConfig {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
