...
/**
* @author lin.he
* @link http://47.108.135.148:17600/doc.html#/default/应用消息配置相关/checkBatchUsingPOST
*/
...
export interface IAppmessageconfigbatchcheckrequestdto {
    /** 应用消息配置ID列表 */
    idList?: string[];
    /** 应用引擎 */
    flowPath?: IProcessResponseVO;
    /** 字段列表 */
...
export interface IProcessResponseVO {
    ...
    /** 是否系统级流程 */
    isSystem?: EProcessResponseVO_isSystem;
    /** 系统流程类型 */
    flowPathSystemType?: EProcessResponseVO_flowPathSystemType;
    /** 排序 */
    sort?: number;
    /** 流程结果通知 */
    flowPathResultNotify?: EProcessResponseVO_flowPathResultNotify;
    /** 重新提交通知 */
    recommitNotify?: EProcessResponseVO_recommitNotify;
    /** 作废停用通知 */
    invalidNotify?: EProcessResponseVO_invalidNotify;
    /** 删除通知 */
    deleteNotify?: EProcessResponseVO_deleteNotify;
...
export enum EProcessResponseVO_type {
    /** 单据 */
    BILL = "BILL",
    /** 基础数据 */
    DATA = "DATA",
...
export enum EProcessResponseVO_isSystem {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessResponseVO_flowPathSystemType {
    /** 仓库 */
...
export enum EProcessResponseVO_recommitNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessResponseVO_invalidNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessResponseVO_deleteNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessResponseVO_applicationLevel {
    /** 项目管理 */
