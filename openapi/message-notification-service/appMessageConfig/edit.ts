...
/**
* @link http://47.108.139.107:17600/doc.html#/default/应用消息配置相关/editUsingPOST
*/
export default function fetchMethod(options: { data: IAppMessageConfigDTO }, extraOptions?: any) {
