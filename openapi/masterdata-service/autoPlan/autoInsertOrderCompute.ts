...
*/
export default function fetchMethod(options: { data: IProductionOrderAutomaticInsertionDTOparams: { enterpriseId?: number, extraOptions?: any) {
...
export interface IProductionOrderAutomaticInsertionDTO {
    ...
    isAutoMoveUp?: ('Y' | 'N');
    /** 插单类型 */
    insertOrderType?: ('TIME' | 'ORDER');
    /** 插单时间 yyyy-MM-dd HH:mm:ss */
    insertTime?: string;
    /** 插单生产订单id */
    insertProduceOrderId?: number;
    /** 插单位置 */
    insertOrderPosition?: ('BEFORE' | 'AFTER');
}
/** JSONResult«排产计算结果VO» */
