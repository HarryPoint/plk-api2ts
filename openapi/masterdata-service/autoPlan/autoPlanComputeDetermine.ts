...
*/
export default function fetchMethod(data: IProductionOrderAutomaticSchedulingCalculationResultsToDetermineTheDTO, params: { enterpriseId: number }, extraOptions?: any) {
