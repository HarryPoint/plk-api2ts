...
// http://47.108.139.107:16700/doc.html#/default/项目概况相关/queryProjectQualityIssueCompleteCountUsingPOST_1
export default function fetchMethod(data: IProjectOverviewQueryDto) {
    return post<IJSONResultStatisticalResponseObjectForProjectQualityProblems['data']>({
