...
/**
* @author MaoHaiPing
* @link http://47.108.139.107:16700/doc.html#/default/项目概况相关/queryProjectQualityIssueCompleteCountUsingPOST_1
*/
export default function fetchMethod(options: { data: IProjectOverviewQueryDto }, extraOptions?: any) {
    return http<IJSONResultStatisticalResponseObjectForProjectQualityProblems>(
        {
            url: "/masterdata-service/projectOverview/queryProjectQualityIssueCompleteCount",
            method: "POST",
            ...options,
        },
        extraOptions,
