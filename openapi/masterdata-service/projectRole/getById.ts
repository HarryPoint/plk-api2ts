...
/**
* @link http://47.108.139.107:16700/doc.html#/default/项目角色相关/getByIdUsingPOST_1
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVOparams: { flowPathId?: number; projectId?: number, extraOptions?: any) {
...
export interface IProjectRoleEditsRespondToDtos {
    ...
    flowPathCode?: string;
    /** 是否自定义提交按钮文案 */
    isCustomSubmitContent?: EProjectRoleEditsRespondToDtos_isCustomSubmitContent;
    /** 自定义提交按钮文案 */
    ...
    /** 应用级别 */
    applicationLevel?: EProjectRoleEditsRespondToDtos_applicationLevel;
    /** 服务对象ID */
...
export enum EProjectRoleEditsRespondToDtos_isCustomSubmitContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProjectRoleEditsRespondToDtos_applicationLevel {
    /** 项目管理 */
