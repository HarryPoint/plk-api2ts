...
/**
* @link http://47.108.139.107:16700/doc.html#/default/生产任务相关/getProduceTaskByQueryTypeAndProcessIdUsingPOST
*/
export default function fetchMethod(options: { data: IProductionTaskQueryDTOForMobileEndparams: { enterpriseId?: number, extraOptions?: any) {
    return http<IJSONResultPageInformationProductionTaskResponseDTOForMobile>(
        {
            url: "/masterdata-service/produceTask/getProduceTaskByQueryTypeAndProcessId",
            method: "post",
            ...options,
        },
        extraOptions,
