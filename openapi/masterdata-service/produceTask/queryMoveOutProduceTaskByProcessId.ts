...
/**
* @link http://47.108.139.107:16700/doc.html#/default/生产任务相关/queryMoveOutProduceTaskByProcessIdUsingPOST
*/
export default function fetchMethod(options: { data: IProductionTaskQueryDTOForMobileEnd, params: { enterpriseId?: string; userId?: string } }, extraOptions?: any) {
    return http<IJSONResultPageInformationProductionTaskResponseDTOForMobile>(
        {
            url: "/masterdata-service/produceTask/queryMoveOutProduceTaskByProcessId",
            method: "post",
            ...options,
        },
        extraOptions,
...
export interface IJSONResultPageInformationProductionTaskResponseDTOForMobile {
    /** 返回码 */
    code?: number;
    /** 返回消息说明 */
    msg?: string;
    /** 响应结果 */
    data?: IPagingInformationProductionTaskResponseDTOForMobile;
    /** 服务器结果返回时的 Unix timestamp,单位毫秒 */
    ts?: string;
}
/** 分页信息«生产任务响应DTO(针对移动端)» */
export interface IPagingInformationProductionTaskResponseDTOForMobile {
    /** 当前页码 */
    pageNo?: string;
    /** 分页大小 */
    pageSize?: string;
    ...
    totalCount?: string;
    /** 分页列表 */
    list?: IProductionTaskResponseDTOForMobile[];
    /** 最后页页码 */
    lastPage?: string;
    /** 是否有上一页 */
    hasPreviousPage?: EPagingInformationProductionTaskResponseDTOForMobile_hasPreviousPage;
    /** 是否有下一页 */
    hasNextPage?: EPagingInformationProductionTaskResponseDTOForMobile_hasNextPage;
    /** 上一页页码 */
    previousPage?: string;
    /** 下一页页码 */
    nextPage?: string;
...
export enum EPagingInformationProductionTaskResponseDTOForMobile_hasPreviousPage {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EPagingInformationProductionTaskResponseDTOForMobile_hasNextPage {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
