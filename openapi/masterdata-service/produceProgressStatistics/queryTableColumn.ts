...
/**
* @author 
* @link http://47.108.135.148:16700/doc.html#/default/生产进度统计报表 - 相关/queryTableColumnUsingGET
*/
...
/** JSONResult«ProduceProgressStatisticTableHeadDTO» */
export interface IJSONResultProduceProgressStatisticTableHeadDTO {
    /** 返回码 */
    code?: number;
    /** 响应结果 */
    data?: IProduceProgressStatisticTableHeadDTO;
    /** 返回消息说明 */
    msg?: string;
...
/** StatisticsTableColumnDTO */
export interface IStatisticsTableColumnDTO {
    /** 编码 */
    code?: string;
    /** 名称 */
    name?: string;
}
/** ProcessTableColumnDTO */
export interface IProcessTableColumnDTO {
    /** 工序编码 */
    processCode?: string;
    /** 工序ID */
    processId?: string;
    ...
    processName?: string;
    /** 进度表列列表 */
    statisticsTableColumnList?: IStatisticsTableColumnDTO[];
}
/** 流程表格列VO */
