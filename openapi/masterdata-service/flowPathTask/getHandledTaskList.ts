...
/**
* @author lin.he
* @link http://47.108.135.148:16700/doc.html#/default/流程任务相关/getHandledTaskListUsingPOST
*/
...
export interface IProcessTaskProcessingResultVO {
    ...
    /** 执行状态 */
    executeStatus?: EProcessTaskProcessingResultVO_executeStatus;
    /** 所属流程节点名称 */
    ...
    taskNo?: string;
    /** 任务类型 */
    type?: EProcessTaskProcessingResultVO_type;
}

export enum EProcessTaskResultQueryVO_flowPathSystemType {
    /** 仓库 */
...
export enum EProcessTaskProcessingResultVO_approvalStatus {
    /** 同意 */
    PASS = "PASS",
    /** 拒绝 */
    REFUSE = "REFUSE",
...
export enum EProcessTaskProcessingResultVO_executeStatus {
    /** 正常执行 */
    HANDLE = "HANDLE",
    /** 回退 */
    BACK = "BACK"
...
export enum EProcessTaskProcessingResultVO_type {
    /** 执行任务 */
    EXECUTE = "EXECUTE",
    /** 审批任务 */
    APPROVAL = "APPROVAL"
