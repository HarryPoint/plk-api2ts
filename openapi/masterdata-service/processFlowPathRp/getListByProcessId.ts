...
/**
* @author 
* @link http://47.108.135.148:16700/doc.html#/default/工序字段对应表相关/getListByProcessIdUsingGET
*/
...
export interface IProcedureFieldsCorrespondToTableDetailsVO {
    ...
    flowPathCode?: string;
    /** 系统流程类型 */
    flowPathSystemType?: EProcedureFieldsCorrespondToTableDetailsVO_flowPathSystemType;
    /** 关联字段列表 */
...
export enum EProcedureFieldsCorrespondToTableDetailsVO_flowPathSystemType {
    /** 仓库 */
...
export enum EProcedureFieldsCorrespondToTableFieldDetailsVO_isTableField {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
