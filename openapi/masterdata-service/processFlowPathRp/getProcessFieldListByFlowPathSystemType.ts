...
*/
export default function fetchMethod(options: { params: { flowPathSystemTypeList?: EflowPathSystemTypeList; processId?: string; enterpriseId?: number } }, extraOptions?: any) {
