...
/**
* @author 
* @link http://47.108.135.148:16700/doc.html#/default/动态数据相关/searchByFlowPathCodeAndSerialNoListUsingPOST
*/
...
export interface IDynamicFormQuery {
    ...
    /** 是否主表 */
    isMasterTable?: EDynamicFormQuery_isMasterTable;
    /** 全局搜索关键字 */
    globalSearch?: string;
}
/** 分页排序VO */
...
export interface IJSONResultDynamicFormQueryOutputVO {
    ...
    msg?: string;
    /** 响应结果 */
    data?: IDynamicFormQueryOutputVO;
...
/** Map«string,object» */
export interface IMapstringobject {
}

export enum EDynamicFormQuery_isMasterTable {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
