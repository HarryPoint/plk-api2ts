...
/**
* @author 
* @link http://47.108.135.148:16700/doc.html#/default/动态数据相关/createDynamicTableUsingPOST
*/
export default function fetchMethod(options: { data: IFlowPathBaseParentFormFieldMapVO, params: { enterpriseId?: string } }, extraOptions?: any) {
...
export interface IFlowPathBaseParentFormFieldMapVO {
    /** undefined */
    flowPathBase?: IFlowPathBaseVO;
    /** undefined */
    parentMap?: Record<string, IProcessFormVO1[]>;
}
/** FlowPathBaseVO */
...
/** 流程表单VO_1 */
export interface IProcessFormVO1 {
    /** id */
    id?: string;
    /** 所属流程id */
    flowPathId?: string;
    ...
    /** 类型分组 */
    typeGroup?: EProcessFormVO1_typeGroup;
    /** 类型 */
    type: EProcessFormVO1_type;
    /** 是否是表格内字段 */
    isTableField?: EProcessFormVO1_isTableField;
    /** 类型描述 */
    typeDesc?: string;
    /** 表格类型 */
    tableType?: EProcessFormVO1_tableType;
    /** 是否是系统表单字段 */
    isSystem?: EProcessFormVO1_isSystem;
    /** 是否是系统预置字段 */
    isSystemPreset?: EProcessFormVO1_isSystemPreset;
    /** 是否是系统必填字段 */
    isSystemMust?: EProcessFormVO1_isSystemMust;
    /** 是否在表格中展示列 */
    isTableShow?: EProcessFormVO1_isTableShow;
    /** 是否是套件 */
    isKit?: EProcessFormVO1_isKit;
    /** 套件类型 */
    kitType?: EProcessFormVO1_kitType;
    /** 套件字段类型 */
    kitColumnType?: EProcessFormVO1_kitColumnType;
    /** 选择类型 */
    selectorType?: EProcessFormVO1_selectorType;
    /** 名称 */
    name: string;
    /** code */
    code?: string;
    ...
    span?: number;
    /** 默认值类型 */
    defaultType?: EProcessFormVO1_defaultType;
    /** 默认日期类型 */
    defaultDateType?: EProcessFormVO1_defaultDateType;
    ...
    /** 是否必填 */
    isMust?: EProcessFormVO1_isMust;
    /** 允许扫码 */
    isScan?: EProcessFormVO1_isScan;
    /** 数值类型 */
    numberType?: EProcessFormVO1_numberType;
    /** 小数位数 */
    scaleDigit?: number;
    /** 是否允许负数 */
    canNegative?: EProcessFormVO1_canNegative;
    /** 数值格式 */
    numberFormat?: EProcessFormVO1_numberFormat;
    /** 日期类型 */
    dateType?: EProcessFormVO1_dateType;
    /** 选项集 - json数组 */
    selectors?: string;
    /** 选项集 */
    ...
    /** 选项值来源 */
    selectorOptionSource?: EProcessFormVO1_selectorOptionSource;
    /** 选项值来源业务编码 */
    selectorOptionSourceBusinessCode?: EProcessFormVO1_selectorOptionSourceBusinessCode;
    /** 选项值是否可修改 */
    isCanModifySelectorOption?: EProcessFormVO1_isCanModifySelectorOption;
    /** 关联表单code */
    formRpCode?: string;
    /** 关联详细表单的编码 */
    ...
    /** 表格自定义字段集 */
    tableCustomFormFields?: IProcessFormVO1[];
    /** 选择框样式 */
    style?: EProcessFormVO1_style;
    ...
    /** 组织类型 */
    organizationType?: EProcessFormVO1_organizationType;
    /** 表格字段列表 */
    actualFields?: Record<string, any>[];
    /** 是否自动获取位置 */
    isAutoGetLocation?: EProcessFormVO1_isAutoGetLocation;
    /** 地址类型 */
    addressType?: EProcessFormVO1_addressType;
    /** 不允许重复 */
    unableRepeat?: EProcessFormVO1_unableRepeat;
    /** 表格内不允许重复 */
    unableRepeatInTable?: EProcessFormVO1_unableRepeatInTable;
    /** 重复提示 */
    repeatTip?: string;
    /** 是否使用有账号的员工 */
    isUseEmployeesWithAccounts?: EProcessFormVO1_isUseEmployeesWithAccounts;
    /** 关联查询显示样式 */
    associationQueryShowStyle?: EProcessFormVO1_associationQueryShowStyle;
    /** 数据联动 */
    dataLinkage?: IFlowPathFormFieldDataLinkageVO;
    /** 字段值限制规则 */
    valueLimitRules?: IFlowPathFormFieldValueLimitRuleEditDTO[];
    /** 是否启用超链接 */
    isHyperlinkEnabled?: EProcessFormVO1_isHyperlinkEnabled;
    /** 是否表格内批量选择 */
    isInsideTableBatchSelect?: EProcessFormVO1_isInsideTableBatchSelect;
...
export enum EProcessFormVO1_typeGroup {
    /** 表单 */
    FORM = "FORM",
    /** 样式 */
    STYLE = "STYLE"
...
export enum EProcessFormVO1_type {
    /** 单行文字 */
...
export enum EProcessFormVO1_isTableField {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_tableType {
    /** 默认类型 */
    DEFAULT = "DEFAULT"
}

export enum EProcessFormVO1_isSystem {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_isSystemPreset {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_isSystemMust {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_isTableShow {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_isKit {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_kitType {
    /** 入库套件 */
...
export enum EProcessFormVO1_kitColumnType {
    /** 物料编码 */
...
export enum EProcessFormVO1_selectorType {
    /** 平铺 */
    FLAT = "FLAT",
    /** 下拉 */
    PULL_DOWN = "PULL_DOWN"
...
export enum EProcessFormVO1_defaultType {
    /** 固定值 */
    FIXED = "FIXED",
    /** 计算公式 */
    FORMULA = "FORMULA",
...
export enum EProcessFormVO1_defaultDateType {
    /** 未配置 */
    NONE = "NONE",
    /** 系统时间 */
    SYSTEM = "SYSTEM",
...
export enum EProcessFormVO1_isMust {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_isScan {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_numberType {
    /** 整数 */
    INTEGER = "INTEGER",
    /** 小数 */
    DECIMAL = "DECIMAL"
...
export enum EProcessFormVO1_canNegative {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_numberFormat {
    /** % */
    F1 = "F1",
    /** ￥ */
    F2 = "F2",
...
export enum EProcessFormVO1_dateType {
    /** 年-月-日 */
    DAY = "DAY",
    /** 年-月-日 时:分 */
    MIN = "MIN",
...
export enum EProcessFormVO1_selectorOptionSource {
    /** 默认填充 */
...
export enum EProcessFormVO1_selectorOptionSourceBusinessCode {
    /** 物料种类 */
...
export enum EProcessFormVO1_isCanModifySelectorOption {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_style {
    /** 高级 */
    ADVANCED = "ADVANCED",
    /** 级联 */
    CASCADE = "CASCADE"
...
export enum EProcessFormVO1_organizationType {
    /** 非组织 */
    NONE = "NONE",
    /** 班组 */
...
export enum EProcessFormVO1_isAutoGetLocation {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_addressType {
    /** 省-市-区-详细地址 */
...
export enum EProcessFormVO1_unableRepeat {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_unableRepeatInTable {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_isUseEmployeesWithAccounts {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_associationQueryShowStyle {
    /** 单行 */
    SINGLE = "SINGLE",
    /** 表格 */
    TABLE = "TABLE"
...
export enum EProcessFormVO1_isHyperlinkEnabled {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessFormVO1_isInsideTableBatchSelect {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
