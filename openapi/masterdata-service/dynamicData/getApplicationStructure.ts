...
/**
* @author lin.he
* @link http://47.108.135.148:16700/doc.html#/default/动态数据相关/getApplicationStructureUsingPOST
*/
...
/** 表单结构VO_2 */
export interface IFormStructureVO2 {
    /** 自定义提交按钮文案 */
    ...
    /** 是否自定义提交按钮文案 */
    isCustomSubmitContent?: EFormStructureVO2_isCustomSubmitContent;
    /** 表单结构 */
...
export enum EFormStructureVO2_isCustomSubmitContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
