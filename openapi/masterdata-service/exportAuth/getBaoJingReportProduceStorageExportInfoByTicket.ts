...
/**
* @author 
* @link http://47.108.135.148:16700/doc.html#/default/导出相关/getBaoJingReportProduceStorageExportInfoByTicketUsingGET
*/
...
export interface IExportInformationBaojingReportProductDailyReportResponseObject {
    /** 导出类型 */
    exportType?: EExportInformationBaojingReportProductDailyReportResponseObject_exportType;
    /** 数据 */
...
export enum EExportInformationBaojingReportProductDailyReportResponseObject_exportType {
    /** 员工数据 */
    USER = "USER",
    /** 物料数据 */
