...
/**
* @author 
* @link http://47.108.135.148:16700/doc.html#/default/导出相关/getWipReportExportInfoByTicketUsingGET
*/
...
export interface IExportInformationWIPStatisticsReportReturnsVO {
    /** 导出类型 */
    exportType?: EExportInformationWIPStatisticsReportReturnsVO_exportType;
    /** 数据 */
...
export enum EExportInformationWIPStatisticsReportReturnsVO_exportType {
    /** 员工数据 */
    USER = "USER",
    /** 物料数据 */
