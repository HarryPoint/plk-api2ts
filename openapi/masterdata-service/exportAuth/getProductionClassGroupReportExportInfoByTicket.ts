...
/**
* @link http://47.108.139.107:16700/doc.html#/default/导出相关/getProductionClassGroupReportExportInfoByTicketUsingGET
*/
...
export interface IExportInformationOutputReportExportVO {
    /** 导出类型 */
    exportType?: EExportInformationOutputReportExportVO_exportType;
    /** 数据 */
...
export enum EExportInformationOutputReportExportVO_exportType {
    /** 员工数据 */
    USER = "USER",
    /** 物料数据 */
