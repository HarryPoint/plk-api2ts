...
/**
* @link http://47.108.139.107:16700/doc.html#/default/导出相关/getProductionDataReportExportInfoByTicketUsingGET
*/
export default function fetchMethod(options: { params: { ticket?: string } }, extraOptions?: any) {
    return http<IJSONResultExportInformationOutputDataStatisticsReturnVO>(
        {
...
export interface IExportInformationOutputDataStatisticsReturnVO {
    /** 导出类型 */
    exportType?: EExportInformationOutputDataStatisticsReturnVO_exportType;
    /** 数据 */
...
export enum EExportInformationOutputDataStatisticsReturnVO_exportType {
    /** 员工数据 */
    USER = "USER",
    /** 物料数据 */
