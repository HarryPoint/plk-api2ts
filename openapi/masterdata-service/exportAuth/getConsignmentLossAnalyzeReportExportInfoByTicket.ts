...
export interface IExportInformationConsignmentLossAnalysisReportPagingBackToVO {
    /** 导出类型 */
    exportType?: EExportInformationConsignmentLossAnalysisReportPagingBackToVO_exportType;
    /** 数据 */
...
export enum EExportInformationConsignmentLossAnalysisReportPagingBackToVO_exportType {
    /** 员工数据 */
    USER = "USER",
    /** 物料数据 */
