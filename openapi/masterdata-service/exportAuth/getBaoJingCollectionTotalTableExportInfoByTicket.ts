...
/**
* @author 
* @link http://47.108.135.148:16700/doc.html#/default/导出相关/getBaoJingCollectionTotalTableExportInfoByTicketUsingGET
*/
...
export interface IExportInformationBaojingCollectionSummaryAnalysisReportFormReturnToVO {
    /** 导出类型 */
    exportType?: EExportInformationBaojingCollectionSummaryAnalysisReportFormReturnToVO_exportType;
    /** 数据 */
...
export enum EExportInformationBaojingCollectionSummaryAnalysisReportFormReturnToVO_exportType {
    /** 员工数据 */
    USER = "USER",
    /** 物料数据 */
