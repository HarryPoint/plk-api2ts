...
*/
export default function fetchMethod(options: { params: { enterpriseCode?: string; enterpriseId?: number; searchJson?: string; type?: string; userId?: number } }, extraOptions?: any) {
