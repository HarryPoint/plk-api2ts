...
export interface IInspectionPlanDynamicDataRespondsToDtos {
    ...
    flowPathCode?: string;
    /** 是否自定义提交按钮文案 */
    isCustomSubmitContent?: EInspectionPlanDynamicDataRespondsToDtos_isCustomSubmitContent;
    /** 自定义提交按钮文案 */
...
/** 巡检作业响应dto */
export interface ITheInspectionJobRespondsToTheDto {
    /** 提前下发模式 */
    preIssueMode?: ETheInspectionJobRespondsToTheDto_preIssueMode;
    /** 提前下发数量 */
    preIssueQuantity?: number;
    /** 下发模式 */
    ...
    /** 每月的时间计算模式 */
    monthCalcTimeMode?: ETheInspectionJobRespondsToTheDto_monthCalcTimeMode;
    /** 周号 */
    weekNo?: number;
    /** 第几天 */
    day?: number;
    /** 每天的时间计算模式 */
    dayCalcTimeMode?: ETheInspectionJobRespondsToTheDto_dayCalcTimeMode;
    /** 间隔小时 */
    intervalHour?: number;
    /** 间隔开始时间 */
...
export enum EInspectionPlanDynamicDataRespondsToDtos_isCustomSubmitContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheInspectionJobRespondsToTheDto_preIssueMode {
    /** 小时 */
    HOUR = "HOUR",
    /** 天 */
    DAY = "DAY",
...
export enum ETheInspectionJobRespondsToTheDto_issueMode {
    /** 单次 */
    SINGLE = "SINGLE",
    /** 循环 */
    MULTIPLE = "MULTIPLE"
...
export enum ETheInspectionJobRespondsToTheDto_timeMode {
    /** 每天 */
    DAY = "DAY",
    /** 每周 */
    WEEK = "WEEK",
...
export enum ETheInspectionJobRespondsToTheDto_monthCalcTimeMode {
    /** 从月初开始计算 */
...
export enum ETheInspectionJobRespondsToTheDto_dayCalcTimeMode {
    /** 定时 */
    FIXED = "FIXED",
    /** 间隔 */
    INTERVAL = "INTERVAL"
