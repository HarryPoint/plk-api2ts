...
/**
* @link http://47.108.139.107:16700/doc.html#/default/费用类型相关/getFlowPathStructureDataUsingPOST_10
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/masterdata-service/produceFeeType/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
