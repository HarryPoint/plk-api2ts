...
/**
* @author XieJian
* @link http://47.108.135.148:16700/doc.html#/default/销售明细报表相关/getDifengSalesDayReportStatisticsUsingPOST_1
*/
export default function fetchMethod(options: { data: any }, extraOptions?: any) {
    return http<IJSONResultSalesStatisticsReturnObject>(
        {
            url: "/masterdata-service/salesDetailsReport/getDifengSalesDayReportStatistics",
            method: "POST",
            ...options,
        },
        extraOptions,
