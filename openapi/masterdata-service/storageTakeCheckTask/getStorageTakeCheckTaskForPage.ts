...
*/
export default function fetchMethod(data: ISearchVOOnTheExecutionSideOfTheWarehouseInventoryTask, params: { enterpriseId: number; userId: number }, extraOptions?: any) {
