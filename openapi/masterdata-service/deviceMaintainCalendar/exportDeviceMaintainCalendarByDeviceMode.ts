...
/**
* @link http://47.108.139.107:16700/doc.html#/default/设备保养日历相关/exportDeviceMaintainCalendarByDeviceModeUsingPOST
*/
export default function fetchMethod(data: IEquipmentMaintenanceCalendarRequestDTO, extraOptions?: any) {
    return http<IJSONResultlong>(
        {
            url: "/masterdata-service/deviceMaintainCalendar/exportDeviceMaintainCalendarByDeviceMode",
            method: "post",
            data,
        },
        extraOptions,
