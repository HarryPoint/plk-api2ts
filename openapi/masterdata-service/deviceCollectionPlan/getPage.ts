...
/**
* @link http://47.108.139.107:16700/doc.html#/default/设备数采数据方案相关/getPageUsingPOST_4
*/
export default function fetchMethod(options: { data: IDeviceDataSchemeSearchVOparams: { enterpriseId?: number, extraOptions?: any) {
