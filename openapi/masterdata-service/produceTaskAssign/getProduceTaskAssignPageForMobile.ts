...
export default function fetchMethod(data: IProductionTaskAssignmentQueryVOForMobile, params: { enterpriseId: number }) {
    return post<IJSONResultPageInformationProductionTaskAssignmentVOForMobile['data']>({
