...
export interface IJSONResult分页信息ProductionStockReturnQueryResponseDTO {
    // 返回码
    code: number;
    // 返回消息说明
    msg: string;
    // 响应结果
    data: I分页信息ProductionStockReturnQueryResponseDTO;
    // 服务器结果返回时的 Unix timestamp,单位毫秒
    ts: number;
}
// 分页信息«ProductionStockReturnQueryResponseDTO»
export interface I分页信息ProductionStockReturnQueryResponseDTO {
    // 当前页码
    pageNo: number;
    // 分页大小
    pageSize: number;
