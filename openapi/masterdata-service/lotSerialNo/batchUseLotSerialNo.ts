...
// http://47.108.139.107:16700/doc.html#/default/批次|序列号相关/batchUseLotSerialNoUsingPOST
export default function fetchMethod(data: string[]) {
    return post<IJSONResultTheBatchNumberIsDTO1>({
      url: "/masterdata-service/lotSerialNo/batchUseLotSerialNo",
      data,
    });
}
