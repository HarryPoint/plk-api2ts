...
/**
* @link http://47.108.139.107:16700/doc.html#/default/QMS大屏相关/queryManageAuditAuditImprovementRectificationUsingPOST
*/
export default function fetchMethod(data: IImprovementRecificationQueryRequestDTO, extraOptions?: any) {
    return http<IJSONResultImprovesTheRectificationRate>(
        {
            url: "/masterdata-service/qmsDashboard/queryManageAuditAuditImprovementRectification",
            method: "post",
            data,
        },
        extraOptions,
