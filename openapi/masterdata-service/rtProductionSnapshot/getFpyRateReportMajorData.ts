...
/**
* @author 
* @link http://47.108.139.107:16700/doc.html#/default/生产快照相关/getFpyRateReportMajorDataUsingPOST
*/
export default function fetchMethod(options: { data: IOutputClassReportSearchVO, params: { enterpriseId?: string } }, extraOptions?: any) {
    return http<IJSONResultOutputLineChartReturnsVOPassthroughReportReturnsVO>(
        {
...
export interface IOutputLineChartReturnVODirectReportReturnVO {
    ...
    isConsistent?: EOutputLineChartReturnVODirectReportReturnVO_isConsistent;
    /** 实际查询时间 - 开始 */
...
export enum EOutputLineChartReturnVODirectReportReturnVO_isConsistent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
