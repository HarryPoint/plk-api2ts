...
/**
* @author Mao Hai Ping
* @link http://47.108.139.107:16700/doc.html#/default/生产成本相关/checkProductionMaterialIssuanceOrderUsingGET
*/
export default function fetchMethod(options: { params: { fiscalPeriodId?: string } }, extraOptions?: any) {
    return http<IJSONResultListProductionCostAccountingDocumentStatusVerificationResponseDTO>(
        {
            url: "/masterdata-service/produceCost/checkProductionMaterialIssuanceOrder",
            method: "GET",
            ...options,
        },
        extraOptions,
