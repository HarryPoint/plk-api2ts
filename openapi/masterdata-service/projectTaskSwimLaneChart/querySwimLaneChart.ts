...
/**
* @author XieJian
* @link http://47.108.135.148:16700/doc.html#/default/项目任务泳道图相关/querySwimLaneChartUsingGET
*/
...
export interface IItemTaskLaneMapTaskResponseObject {
    ...
    /** 应用类型 */
    appType?: EItemTaskLaneMapTaskResponseObject_appType;
    /** 任务负责人角色ids */
    leaderUserProjectRoleIds?: string[];
    /** 任务状态 */
    taskStatus?: EItemTaskLaneMapTaskResponseObject_taskStatus;
    /** 前置任务ids */
    preTaskIds?: string[];
    /** 项目阶段id */
    projectStageId?: string;
    /** 评审不通过，任务返回至 */
    returnTaskIds?: string[];
}
/** 项目任务泳道图角色响应对象 */
...
export enum EItemTaskLaneMapTaskResponseObject_appType {
    /** 仓库 */
...
export enum EItemTaskLaneMapTaskResponseObject_taskStatus {
    /** 草稿 */
    DRAFT = "DRAFT",
    /** 未下发 */
    UN_ISSUE = "UN_ISSUE",
