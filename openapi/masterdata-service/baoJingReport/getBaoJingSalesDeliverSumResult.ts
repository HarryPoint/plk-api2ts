...
/**
* @link http://47.108.139.107:16700/doc.html#/default/宝晶报表相关/getBaoJingSalesDeliverSumResultUsingPOST
*/
export default function fetchMethod(options: { data: IBaojingSalesDeliveryReportSearchVOparams: { enterpriseId?: number, extraOptions?: any) {
