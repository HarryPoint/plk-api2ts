...
export default function fetchMethod(params: { applicationId?: number; id?: number; voucherNo?: string }) {
    return get<IJSONResultExternalFinancialCertificateResponseObject['data']>({
