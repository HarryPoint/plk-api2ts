...
/**
* @author helin
* @link http://47.108.135.148:16700/doc.html#/default/项目任务相关/pageQueryOfDecisionTaskTypeUsingPOST
*/
...
export interface IProjectTaskPagingQueryResponse {
    ...
    id?: string;
    /** 修改比较类型 */
    modifyCompareType?: EProjectTaskPagingQueryResponse_modifyCompareType;
    /** 修改规则值 */
    ...
    name?: string;
    /** 不通过比较类型 */
    notPassCompareType?: EProjectTaskPagingQueryResponse_notPassCompareType;
    /** 不通过的临界值 */
    notPassRuleValue?: number;
    /** 通过的比较类型 */
    passCompareType?: EProjectTaskPagingQueryResponse_passCompareType;
    /** 通过比较值 */
    ...
    /** 带风险通过的比较类型 */
    takeRiskPassCompareType?: EProjectTaskPagingQueryResponse_takeRiskPassCompareType;
    /** 带风险通过比较值 */
...
export enum EItemTaskPagingQueryResponse1_systemType {
    /** 仓库 */
...
export enum EPageInformationItemTaskPageQueryResponse_hasNextPage {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EPageInformationItemTaskPageQueryResponse_hasPreviousPage {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProjectTaskPagingQueryResponse_modifyCompareType {
    /** 大于 */
    GT = "GT",
    /** 大于等于 */
    GE = "GE"
...
export enum EProjectTaskPagingQueryResponse_notPassCompareType {
    /** 大于 */
    GT = "GT",
    /** 大于等于 */
    GE = "GE"
...
export enum EProjectTaskPagingQueryResponse_passCompareType {
    /** 大于 */
    GT = "GT",
    /** 大于等于 */
    GE = "GE"
...
export enum EProjectTaskPagingQueryResponse_takeRiskPassCompareType {
    /** 大于 */
    GT = "GT",
    /** 大于等于 */
    GE = "GE"
