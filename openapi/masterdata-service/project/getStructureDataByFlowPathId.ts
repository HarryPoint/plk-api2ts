...
/**
* @author lin.he
* @link http://47.108.135.148:16700/doc.html#/default/项目相关/getStructureDataUsingPOST
*/
...
export interface IProjectDynamicFormRecordQuery {
    ...
    projectId?: string;
    /** 系统类型 */
    systemType?: EProjectDynamicFormRecordQuery_systemType;
    /** 表单记录ID */
    id?: string;
}
/** JSONResult«表单结构VO» */
...
export enum EProjectDynamicFormRecordQuery_systemType {
    /** 仓库 */
