...
export default function fetchMethod(data: GetHandlingOfNonConformingStatisticsAmountReport) {
    return post<IJSONResultTotalUnqualifiedReportsAreReturnedToTheDTO['data']>({
