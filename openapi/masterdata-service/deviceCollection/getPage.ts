...
/**
* @author 
* @link http://47.108.135.148:16700/doc.html#/default/设备数采数据概览相关/getPageUsingPOST_2
*/
export default function fetchMethod(options: { data: IDeviceDataOverviewSearchVO, params: { EnterpriseId?: string } }, extraOptions?: any) {
