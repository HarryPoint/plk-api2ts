...
/**
* @author 
* @link http://47.108.135.148:16700/doc.html#/default/员工相关/getFlowPathStructureDataUsingPOST_2
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO, params: { enterpriseId?: string } }, extraOptions?: any) {
    return http<IJSONResultUserDynamicDataResponseDTO>(
        {
            url: "/masterdata-service/employee/getFlowPathStructureData",
            method: "POST",
            ...options,
        },
        extraOptions,
...
export interface IJSONResultUserDynamicDataResponseDTO {
    ...
    code?: number;
    /** 响应结果 */
    data?: IUserDynamicDataResponseDTO;
    /** 返回消息说明 */
    msg?: string;
...
/** 用户动态数据响应DTO */
export interface IUserDynamicDataResponseDTO {
    /** 自定义提交按钮文案 */
    ...
    /** 是否允许登录 */
    isAllowLogin?: EUserDynamicDataResponseDTO_isAllowLogin;
    /** 是否自定义提交按钮文案 */
    isCustomSubmitContent?: EUserDynamicDataResponseDTO_isCustomSubmitContent;
    /** 角色集 */
...
export enum EUserDynamicDataResponseDTO_isAllowLogin {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EUserDynamicDataResponseDTO_isCustomSubmitContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
