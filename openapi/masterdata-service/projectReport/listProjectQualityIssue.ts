...
// http://47.108.139.107:16700/doc.html#/default/项目报表相关/listProjectQualityIssueUsingPOST
export default function fetchMethod(data: IItemNameNumberPublicQueryObject) {
    return post<IJSONResultListProjectQualityProblemReportResponseObject['data']>({
