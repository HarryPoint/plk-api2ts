...
export default function fetchMethod(data: QueryProjectQualityIssueReport) {
    return post<IJSONResultPagingInformationProjectQualityProblemReportResponseObject['data']>({
