...
/**
* @author TanPeng
* @link http://47.108.135.148:16700/doc.html#/default/项目变更相关/listModificationHistoryUsingGET_1
*/
...
export interface IProjectChangeInformation {
    ...
    updateTime?: number;
    /** 应用类型 */
    systemType?: EProjectChangeInformation_systemType;
}

export enum EProjectChangeInformation_systemType {
    /** 仓库 */
