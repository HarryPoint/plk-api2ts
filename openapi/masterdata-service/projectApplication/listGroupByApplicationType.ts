...
/**
* @author XieJian
* @link http://47.108.135.148:16700/doc.html#/default/项目应用相关/listGroupByApplicationTypeUsingGET
*/
...
export interface IItemApplicationGroupReturnsObject {
    /** 分组类型 */
    applicationType?: EItemApplicationGroupReturnsObject_applicationType;
    /** 应用列表 */
...
export interface ITheProjectApplicationReturnsTheObject {
    ...
    flowPathName?: string;
    /** 应用类型 */
    flowPathSystemType?: ETheProjectApplicationReturnsTheObject_flowPathSystemType;
    /** 应用类型 */
    projectApplicationType?: ETheProjectApplicationReturnsTheObject_projectApplicationType;
    /** 导航排序 */
...
export enum EItemApplicationGroupReturnsObject_applicationType {
    /** 项目设置 */
    ...
    /** 变更管理 */
    MODIFICATION_MANAGE = "MODIFICATION_MANAGE"
}

export enum ETheProjectApplicationReturnsTheObject_flowPathSystemType {
    /** 仓库 */
...
export enum ETheProjectApplicationReturnsTheObject_projectApplicationType {
    /** 项目设置 */
    PROJECT_SETTING = "PROJECT_SETTING",
    /** 默认应用 */
    DEFAULT_APP = "DEFAULT_APP",
