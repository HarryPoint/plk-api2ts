...
export interface IItemApplicationGroupReturnsObject {
    /** 分组类型 */
    applicationType?: ('PROJECT_SETTING' | 'DEFAULT_APP' | 'CUSTOM_APP' | 'MODIFICATION_MANAGE');
    /** 应用列表 */
...
export interface ITheProjectApplicationReturnsTheObject {
    ...
    /** 应用类型 */
    projectApplicationType?: ('PROJECT_SETTING' | 'DEFAULT_APP' | 'CUSTOM_APP' | 'MODIFICATION_MANAGE');
    /** 导航排序 */
