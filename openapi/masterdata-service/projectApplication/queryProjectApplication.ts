...
/**
* @author MaoHaiPing
* @link http://47.108.135.148:16700/doc.html#/default/项目应用相关/queryProjectApplicationUsingPOST
*/
...
export interface IProjectApplicationRequestObject {
    ...
    projectId: string;
    /** 项目id */
    flowPathSystemType: EProjectApplicationRequestObject_flowPathSystemType;
}
/** JSONResult«项目应用返回对象» */
...
export enum EProjectApplicationRequestObject_flowPathSystemType {
    /** 仓库 */
