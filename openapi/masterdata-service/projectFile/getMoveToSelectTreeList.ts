...
/**
* @link http://47.108.139.107:16700/doc.html#/default/项目文件相关/getMoveToSelectTreeListUsingGET_2
*/
export default function fetchMethod(options: { params: { projectId?: string } }, extraOptions?: any) {
    return http<IJSONResultListFileClassificationDetailsResponseDTO5>(
        {
            url: "/masterdata-service/projectFile/getMoveToSelectTreeList",
            method: "get",
            ...options,
        },
        extraOptions,
...
/** JSONResult«List«文件分类明细响应DTO»»_5 */
export interface IJSONResultListFileClassificationDetailsResponseDTO5 {
    /** 返回码 */
    code?: number;
    /** 返回消息说明 */
    msg?: string;
