...
/**
* @author 
* @link http://47.108.139.107:16400/doc.html#/default/单位相关/getFlowPathStructureDataUsingPOST_34
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/unit/getFlowPathStructureData",
            method: "POST",
            ...options,
        },
        extraOptions,
