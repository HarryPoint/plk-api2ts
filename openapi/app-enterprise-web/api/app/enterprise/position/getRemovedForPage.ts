...
/**
* @link http://47.108.139.107:16400/doc.html#/default/职位相关/getRemovedForPageUsingPOST_14
*/
export default function fetchMethod(options: { data: IProcessDataBaseSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/position/getRemovedForPage",
            method: "post",
            ...options,
        },
        extraOptions,
