...
/**
* @link http://47.108.139.107:16400/doc.html#/default/职位相关/getFlowPathStructureDataUsingPOST_22
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/position/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
