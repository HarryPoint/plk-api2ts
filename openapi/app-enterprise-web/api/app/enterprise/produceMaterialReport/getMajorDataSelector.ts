...
/**
* @link http://47.108.139.107:16400/doc.html#/default/产出报表(按物料统计)相关/getMajorDataSelectorUsingPOST_16
*/
export default function fetchMethod(data: IMaterialMasterDataSelectionListSearchVO, extraOptions?: any) {
    return http<IJSONResultPagingInformationMaterialMasterDataSelectionReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/produceMaterialReport/getMajorDataSelector",
            method: "post",
            data,
        },
        extraOptions,
