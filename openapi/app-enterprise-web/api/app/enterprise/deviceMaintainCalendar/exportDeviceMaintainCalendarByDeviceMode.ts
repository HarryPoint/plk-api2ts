...
/**
* @link http://47.108.139.107:16400/doc.html#/default/设备保养日历相关/exportDeviceMaintainCalendarByDeviceModeUsingPOST
*/
export default function fetchMethod(options: { data: IEquipmentMaintenanceCalendarRequestDTO }, extraOptions?: any) {
    return http<IJSONResultlong>(
        {
            url: "/app-enterprise-web/api/app/enterprise/deviceMaintainCalendar/exportDeviceMaintainCalendarByDeviceMode",
            method: "post",
            ...options,
        },
        extraOptions,
