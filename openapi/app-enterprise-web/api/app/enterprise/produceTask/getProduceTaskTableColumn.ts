...
/**
* @author XieJian
* @link http://47.108.135.148:16400/doc.html#/default/生产任务相关/getProduceTaskTableColumnUsingGET
*/
...
export interface IProductionTaskExportTableColumnDTO {
    ...
    /** 列类型 */
    type?: EProductionTaskExportTableColumnDTO_type;
    /** 列code */
    code?: string;
    /** 列名称 */
    name?: string;
    ...
    /** 表单类型分组 */
    formFieldTypeGroup?: EProductionTaskExportTableColumnDTO_formFieldTypeGroup;
    /** 表单类型 */
    formFieldType?: EProductionTaskExportTableColumnDTO_formFieldType;
    /** 表格类型 */
    flowPathFormFieldTableType?: EProductionTaskExportTableColumnDTO_flowPathFormFieldTableType;
    /** 表格内字段集 */
    ...
    serialNo?: string;
    /** 定位类型 */
    fixType?: EProductionTaskExportTableColumnDTO_fixType;
    /** 定位类型排序 */
    fixSort?: number;
    /** 是否显示，控制配置表单是否显示 */
    isShow?: EProductionTaskExportTableColumnDTO_isShow;
    /** 能否查询，控制查询条件是否可勾选 */
    canQuery?: EProductionTaskExportTableColumnDTO_canQuery;
    /** 排序 - 每个定位类型独立排序 */
    sort?: number;
    /** 日期类型 */
    dateType?: EProductionTaskExportTableColumnDTO_dateType;
    /** 是否表格字段 */
    isTableField?: EProductionTaskExportTableColumnDTO_isTableField;
    /** 父级流程表单id */
    parentFlowPathFormFieldId?: string;
    /** 父级流程表单code */
    parentFlowPathFormFieldCode?: string;
    /** 组织类型 */
    organizationType?: EProductionTaskExportTableColumnDTO_organizationType;
    /** 实际存储数据字段列表 --- 数据格式[{"code":"字段编码", "name":"字段名称", "addressFieldCode" : "地址字段编码", "addressFieldSerialNo": "地址字段序列号"}] */
    actualFields?: Record<string, any>[];
    /** 地址类型 */
    addressType?: EProductionTaskExportTableColumnDTO_addressType;
    /** 是否使用有账号的员工 */
    isUseEmployeesWithAccounts?: EProductionTaskExportTableColumnDTO_isUseEmployeesWithAccounts;
    /** 关联表单code */
    formRpCode?: string;
    /** 关联详细表单编码 */
    formDetailRpCode?: string;
    /** 数值格式 */
    numberFormat?: EProductionTaskExportTableColumnDTO_numberFormat;
    /** 关联表单选项显示字段code */
    ...
    /** 选择框样式 */
    style?: EProductionTaskExportTableColumnDTO_style;
    /** 套件类型 */
    kitType?: EProductionTaskExportTableColumnDTO_kitType;
    /** 套件字段类型 */
    kitColumnType?: EProductionTaskExportTableColumnDTO_kitColumnType;
    /** 数值类型 */
    numberType?: EProductionTaskExportTableColumnDTO_numberType;
    /** 是否必填 */
    isMust?: EProductionTaskExportTableColumnDTO_isMust;
    /** 小数位数 */
    scaleDigit?: number;
    /** 是否是系统表单字段 这里表达的是审计字段：id、data_status、create_time 等等 */
    isSystem?: EProductionTaskExportTableColumnDTO_isSystem;
    /** 是否是系统预设字段 */
    isSystemPreset?: EProductionTaskExportTableColumnDTO_isSystemPreset;
    /** 全局不允许重复 */
    unableRepeat?: EProductionTaskExportTableColumnDTO_unableRepeat;
    /** 表格内不允许重复 */
    unableRepeatInTable?: EProductionTaskExportTableColumnDTO_unableRepeatInTable;
    /** 重复提示 */
    repeatTip?: string;
    /** 是否超链接 */
    isHyperlinkEnabled?: EProductionTaskExportTableColumnDTO_isHyperlinkEnabled;
    /** 默认值类型 */
    defaultType?: EProductionTaskExportTableColumnDTO_defaultType;
    /** 默认日期类型 */
    defaultDateType?: EProductionTaskExportTableColumnDTO_defaultDateType;
    /** 默认值 */
    defaultValue?: string;
...
export enum EProductionTaskExportTableColumnDTO_type {
    /** 系统 */
    SYSTEM = "SYSTEM",
    /** 自定义 */
    CUSTOM = "CUSTOM"
...
export enum EProductionTaskExportTableColumnDTO_formFieldTypeGroup {
    /** 表单 */
    FORM = "FORM",
    /** 样式 */
    STYLE = "STYLE"
...
export enum EProductionTaskExportTableColumnDTO_formFieldType {
    /** 单行文字 */
...
export enum EProductionTaskExportTableColumnDTO_flowPathFormFieldTableType {
    /** 默认类型 */
    DEFAULT = "DEFAULT"
}

export enum EProductionTaskExportTableColumnDTO_fixType {
    /** 左侧固定 */
    LEFT = "LEFT",
    /** 不固定 */
    NORMAL = "NORMAL",
...
export enum EProductionTaskExportTableColumnDTO_isShow {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProductionTaskExportTableColumnDTO_canQuery {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProductionTaskExportTableColumnDTO_dateType {
    /** 年-月-日 */
    DAY = "DAY",
    /** 年-月-日 时:分 */
    MIN = "MIN",
...
export enum EProductionTaskExportTableColumnDTO_isTableField {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProductionTaskExportTableColumnDTO_organizationType {
    /** 非组织 */
    NONE = "NONE",
    /** 班组 */
...
export enum EProductionTaskExportTableColumnDTO_addressType {
    /** 省-市-区-详细地址 */
...
export enum EProductionTaskExportTableColumnDTO_isUseEmployeesWithAccounts {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProductionTaskExportTableColumnDTO_numberFormat {
    /** % */
    F1 = "F1",
    /** ￥ */
    F2 = "F2",
...
export enum EProductionTaskExportTableColumnDTO_style {
    /** 高级 */
    ADVANCED = "ADVANCED",
    /** 级联 */
    CASCADE = "CASCADE"
...
export enum EProductionTaskExportTableColumnDTO_kitType {
    /** 入库套件 */
...
export enum EProductionTaskExportTableColumnDTO_kitColumnType {
    /** 物料编码 */
...
export enum EProductionTaskExportTableColumnDTO_numberType {
    /** 整数 */
    INTEGER = "INTEGER",
    /** 小数 */
    DECIMAL = "DECIMAL"
...
export enum EProductionTaskExportTableColumnDTO_isMust {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProductionTaskExportTableColumnDTO_isSystem {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProductionTaskExportTableColumnDTO_isSystemPreset {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProductionTaskExportTableColumnDTO_unableRepeat {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProductionTaskExportTableColumnDTO_unableRepeatInTable {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProductionTaskExportTableColumnDTO_isHyperlinkEnabled {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProductionTaskExportTableColumnDTO_defaultType {
    /** 固定值 */
    FIXED = "FIXED",
    /** 计算公式 */
    FORMULA = "FORMULA",
...
export enum EProductionTaskExportTableColumnDTO_defaultDateType {
    /** 未配置 */
    NONE = "NONE",
    /** 系统时间 */
    SYSTEM = "SYSTEM",
