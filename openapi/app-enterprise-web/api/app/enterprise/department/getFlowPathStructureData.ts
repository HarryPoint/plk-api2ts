...
/**
* @link http://47.108.139.107:16400/doc.html#/default/部门相关/getFlowPathStructureDataUsingPOST_10
*/
export default function fetchMethod(data: IProcessStructureSearchVO, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/department/getFlowPathStructureData",
            method: "post",
            data,
        },
        extraOptions,
