...
/**
* @link http://47.108.139.107:16400/doc.html#/default/部门相关/getRemovedForPageUsingPOST_6
*/
export default function fetchMethod(options: { data: IProcessDataBaseSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/department/getRemovedForPage",
            method: "post",
            ...options,
        },
        extraOptions,
