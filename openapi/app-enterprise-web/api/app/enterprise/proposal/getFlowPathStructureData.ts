...
/**
* @link http://47.108.139.107:16400/doc.html#/default/合理化建议相关/getFlowPathStructureDataUsingPOST_25
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/proposal/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
