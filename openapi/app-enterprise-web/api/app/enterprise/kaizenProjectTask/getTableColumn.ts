...
/**
* @link http://47.108.139.107:16400/doc.html#/default/项目任务相关/getTableColumnUsingGET_18
*/
export default function fetchMethod(options: {}, extraOptions?: any) {
    return http<IJSONResultListProcessTableColumnVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/kaizenProjectTask/getTableColumn",
            method: "get",
            ...options,
        },
        extraOptions,
