...
/**
* @link http://47.108.139.107:16400/doc.html#/default/项目任务相关/getFlowPathStructureDataUsingPOST_18
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/kaizenProjectTask/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
