...
/**
* @link http://47.108.139.107:16400/doc.html#/default/销售订单相关/getFlowPathStructureDataUsingPOST_30
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/salesOrder/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
