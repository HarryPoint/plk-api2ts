...
/**
* @link http://47.108.139.107:16400/doc.html#/default/销售订单相关/getRemovedForPageUsingPOST_18
*/
export default function fetchMethod(data: IProcessDataBaseSearchVO, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/salesOrder/getRemovedForPage",
            method: "post",
            data,
        },
        extraOptions,
