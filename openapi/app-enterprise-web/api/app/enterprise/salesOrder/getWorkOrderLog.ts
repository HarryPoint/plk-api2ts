...
/**
* @author 
* @link http://47.108.139.107:16400/doc.html#/default/销售订单相关/getWorkOrderLogUsingPOST_28
*/
export default function fetchMethod(options: { data: IJobLogSearchVO }, extraOptions?: any) {
    return http<IJSONResultThePageInformationWorkOrderLogReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/salesOrder/getWorkOrderLog",
            method: "POST",
            ...options,
        },
        extraOptions,
