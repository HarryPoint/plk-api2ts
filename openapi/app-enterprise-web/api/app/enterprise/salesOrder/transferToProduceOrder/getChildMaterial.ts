...
/**
* @link http://47.108.139.107:16400/doc.html#/default/销售订单相关/getChildMaterialListUsingPOST
*/
export default function fetchMethod(data: IProductionSubMaterialQueryRequest[], extraOptions?: any) {
    return http<IJSONResultListInformationAboutProductionSubMaterials>(
        {
            url: "/app-enterprise-web/api/app/enterprise/salesOrder/transferToProduceOrder/getChildMaterial",
            method: "post",
            data,
        },
        extraOptions,
