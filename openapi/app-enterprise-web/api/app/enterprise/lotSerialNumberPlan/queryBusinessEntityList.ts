...
/**
* @author lin.he
* @link http://47.108.135.148:16400/doc.html#/default/批次方案相关/queryBusinessEntityListUsingGET
*/
export default function fetchMethod(options: {} = {}, extraOptions?: any) {
    return http<ITheJSONResultListProcessRespondsToVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/lotSerialNumberPlan/queryBusinessEntityList",
            method: "GET",
            ...options,
        },
        extraOptions,
...
export interface ITheJSONResultListProcessRespondsToVO {
    ...
    msg?: string;
    /** 响应结果 */
    data?: ITheFlowRespondsToVO2[];
    /** 服务器结果返回时的 Unix timestamp,单位毫秒 */
    ts?: string;
}
/** 流程响应VO_2 */
export interface ITheFlowRespondsToVO2 {
    /** id */
    id?: string;
    /** 所属企业id */
    enterpriseId?: string;
    ...
    code?: string;
    /** 应用类型 */
    type?: ETheFlowRespondsToVO2_type;
    /** 最新版本号 */
    ...
    /** 是否系统级流程 */
    isSystem?: ETheFlowRespondsToVO2_isSystem;
    /** 系统流程类型 */
    flowPathSystemType?: ETheFlowRespondsToVO2_flowPathSystemType;
    /** 排序 */
    sort?: number;
    /** 流程结果通知 */
    flowPathResultNotify?: ETheFlowRespondsToVO2_flowPathResultNotify;
    /** 重新提交通知 */
    recommitNotify?: ETheFlowRespondsToVO2_recommitNotify;
    /** 作废停用通知 */
    invalidNotify?: ETheFlowRespondsToVO2_invalidNotify;
    /** 删除通知 */
    deleteNotify?: ETheFlowRespondsToVO2_deleteNotify;
    /** 数据状态 0停用，1启用，2暂存，-1已删除 */
    dataStatus?: number;
    /** 应用服务包ID */
    appServicePackId?: string;
    /** 应用级别 */
    applicationLevel?: ETheFlowRespondsToVO2_applicationLevel;
    /** 字段列表 */
    fieldList?: IProcessFormVO[];
}
/** 流程表单VO */
...
export enum ETheFlowRespondsToVO2_type {
    /** 单据 */
    BILL = "BILL",
    /** 基础数据 */
    DATA = "DATA",
...
export enum ETheFlowRespondsToVO2_isSystem {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheFlowRespondsToVO2_flowPathSystemType {
    /** 仓库 */
...
export enum ETheFlowRespondsToVO2_flowPathResultNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheFlowRespondsToVO2_recommitNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheFlowRespondsToVO2_invalidNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheFlowRespondsToVO2_deleteNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheFlowRespondsToVO2_applicationLevel {
    /** 项目管理 */
