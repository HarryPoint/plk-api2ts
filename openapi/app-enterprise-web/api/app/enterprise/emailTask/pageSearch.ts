...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/邮件任务/pageSearchUsingPOST
*/
...
export interface IPage2 {
    ...
    updateUserId?: string;
    /** 发送模式-精确匹配 */
    sendingMode?: EPage2_sendingMode;
    /** 创建时间-结束范围 */
    createTimeEnd?: number;
    /** 任务状态-精确匹配 */
    status?: EPage2_status;
    /** 修改时间-结束范围 */
...
export enum EPage2_sendingMode {
    /** 单次 */
    SINGLE = "SINGLE",
    /** 多次 */
    MULTIPLE = "MULTIPLE"
