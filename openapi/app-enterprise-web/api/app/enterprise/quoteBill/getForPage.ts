...
/**
* @link http://47.108.139.107:16400/doc.html#/default/CRM-报价单相关/getPageByFlowPathIdUsingPOST_11
*/
export default function fetchMethod(data: IProcessDataBaseSearchVO, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/quoteBill/getForPage",
            method: "post",
            data,
        },
        extraOptions,
