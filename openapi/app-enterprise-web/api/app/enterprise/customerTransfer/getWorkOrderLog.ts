...
/**
* @author 
* @link http://47.108.139.107:16400/doc.html#/default/CRM-客户转移相关/getWorkOrderLogUsingPOST_9
*/
export default function fetchMethod(options: { data: IJobLogSearchVO }, extraOptions?: any) {
    return http<IJSONResultThePageInformationWorkOrderLogReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/customerTransfer/getWorkOrderLog",
            method: "POST",
            ...options,
        },
        extraOptions,
