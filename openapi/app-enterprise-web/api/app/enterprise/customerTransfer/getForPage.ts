...
/**
* @link http://47.108.139.107:16400/doc.html#/default/CRM-客户转移相关/getPageByFlowPathIdUsingPOST_3
*/
export default function fetchMethod(options: { data: IProcessDataBaseSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/customerTransfer/getForPage",
            method: "post",
            ...options,
        },
        extraOptions,
