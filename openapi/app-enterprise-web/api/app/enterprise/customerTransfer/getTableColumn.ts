...
/**
* @link http://47.108.139.107:16400/doc.html#/default/CRM-客户转移相关/getTableColumnUsingGET_8
*/
export default function fetchMethod(extraOptions?: any) {
    return http<IJSONResultListProcessTableColumnVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/customerTransfer/getTableColumn",
            method: "get",
        },
        extraOptions,
    );
