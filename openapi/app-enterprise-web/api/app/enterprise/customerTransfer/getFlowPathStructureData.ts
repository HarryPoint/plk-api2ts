...
/**
* @link http://47.108.139.107:16400/doc.html#/default/CRM-客户转移相关/getFlowPathStructureDataUsingPOST_8
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/customerTransfer/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
