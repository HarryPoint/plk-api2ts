...
/**
* @link http://47.108.139.107:16400/doc.html#/default/班组相关/getRemovedForPageUsingPOST_3
*/
export default function fetchMethod(data: IProcessDataBaseSearchVO, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/classGroup/getRemovedForPage",
            method: "post",
            data,
        },
        extraOptions,
