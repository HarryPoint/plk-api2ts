...
/**
* @link http://47.108.139.107:16400/doc.html#/default/班组相关/getFlowPathStructureDataUsingPOST_4
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultGroupDynamicDataVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/classGroup/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
...
/** JSONResult«班组动态数据VO» */
export interface IJSONResultGroupDynamicDataVO {
    /** 返回码 */
    code?: number;
    /** 返回消息说明 */
    msg?: string;
    /** 响应结果 */
    data?: ITeamDynamicDataVO;
    /** 服务器结果返回时的 Unix timestamp,单位毫秒 */
    ts?: string;
}
/** 班组动态数据VO */
export interface ITeamDynamicDataVO {
    /** 流程id */
    flowPathId?: string;
    /** 流程版本 */
    ...
    flowPathCode?: string;
    /** 是否自定义提交按钮文案 */
    isCustomSubmitContent?: ETeamDynamicDataVO_isCustomSubmitContent;
    /** 自定义提交按钮文案 */
...
export enum ETeamDynamicDataVO_isCustomSubmitContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
