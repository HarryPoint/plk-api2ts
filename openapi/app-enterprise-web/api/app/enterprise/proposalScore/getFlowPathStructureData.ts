...
/**
* @link http://47.108.139.107:16400/doc.html#/default/合理化建议评分相关/getFlowPathStructureDataUsingPOST_26
*/
export default function fetchMethod(data: IProcessStructureSearchVO, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/proposalScore/getFlowPathStructureData",
            method: "post",
            data,
        },
        extraOptions,
