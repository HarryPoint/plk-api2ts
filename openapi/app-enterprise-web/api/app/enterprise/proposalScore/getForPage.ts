...
/**
* @link http://47.108.139.107:16400/doc.html#/default/合理化建议评分相关/getPageByFlowPathIdUsingPOST_10
*/
export default function fetchMethod(options: { data: IProcessDataBaseSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/proposalScore/getForPage",
            method: "post",
            ...options,
        },
        extraOptions,
