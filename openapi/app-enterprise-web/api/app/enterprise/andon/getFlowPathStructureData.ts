...
/**
* @link http://47.108.139.107:16400/doc.html#/default/安灯相关/getFlowPathStructureDataUsingPOST
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/andon/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
