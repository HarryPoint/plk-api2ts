...
/**
* @author 
* @link http://47.108.139.107:16400/doc.html#/default/质检统计/getMajorDataSelectorUsingPOST_18
*/
export default function fetchMethod(options: { data: IMaterialMasterDataSelectionListSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationMaterialMasterDataSelectionReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/qualityGoodScrapReport/getMajorDataSelector",
            method: "POST",
            ...options,
        },
        extraOptions,
