...
/**
* @link http://47.108.139.107:16400/doc.html#/default/物料相关/getFlowPathStructureDataUsingPOST_20
*/
export default function fetchMethod(data: IProcessStructureSearchVO, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/material/getFlowPathStructureData",
            method: "post",
            data,
        },
        extraOptions,
