...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/自定义应用相关/exportUsingPOST_8
*/
export default function fetchMethod(options: { data: IProcessDataSearchVO, params: { flowPathId?: string } }, extraOptions?: any) {
