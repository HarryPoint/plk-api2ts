...
/**
* @link http://47.108.139.107:16400/doc.html#/default/自定义应用相关/getPageByFlowPathIdUsingPOST_2
*/
export default function fetchMethod(options: { data: IProcessDataBaseSearchVOparams: { flowPathId?: number, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/customApplication/getForPage",
            method: "post",
            ...options,
        },
        extraOptions,
