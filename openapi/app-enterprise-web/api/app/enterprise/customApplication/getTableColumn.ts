...
/**
* @link http://47.108.139.107:16400/doc.html#/default/自定义应用相关/getTableColumnUsingGET_6
*/
export default function fetchMethod(options: { params: { flowPathId?: number } }, extraOptions?: any) {
    return http<IJSONResultListProcessTableColumnVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/customApplication/getTableColumn",
            method: "get",
            ...options,
        },
        extraOptions,
