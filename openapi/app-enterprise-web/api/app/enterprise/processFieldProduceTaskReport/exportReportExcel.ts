...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/任务汇总表(基于工序字段)/exportReportExcelUsingPOST_1
*/
export default function fetchMethod(options: { data: ITheTaskSummaryTableSearchesVOBasedOnProcessFields }, extraOptions?: any) {
    return http<IJSONResultlong>(
        {
            url: "/app-enterprise-web/api/app/enterprise/processFieldProduceTaskReport/exportReportExcel",
            method: "POST",
            ...options,
        },
        extraOptions,
