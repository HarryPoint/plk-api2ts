...
/**
* @author XieJian
* @link http://47.108.139.107:16400/doc.html#/default/项目相关/getWorkOrderLogUsingPOST_17
*/
export default function fetchMethod(options: { data: IJobLogSearchVO }, extraOptions?: any) {
    return http<IJSONResultThePageInformationWorkOrderLogReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/kaizenProject/getWorkOrderLog",
            method: "POST",
            ...options,
        },
        extraOptions,
