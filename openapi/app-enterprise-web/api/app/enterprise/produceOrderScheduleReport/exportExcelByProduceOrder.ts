...
/**
* @link http://47.108.139.107:16400/doc.html#/default/订单排产报表/exportExcelByProduceOrderUsingPOST
*/
export default function fetchMethod(options: { data: IProductionSchedulingOrderSearchVO }, extraOptions?: any) {
    return http<IJSONResultlong>(
        {
            url: "/app-enterprise-web/api/app/enterprise/produceOrderScheduleReport/exportExcelByProduceOrder",
            method: "post",
            ...options,
        },
        extraOptions,
