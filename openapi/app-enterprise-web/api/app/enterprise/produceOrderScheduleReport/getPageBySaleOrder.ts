...
/**
* @link http://47.108.139.107:16400/doc.html#/default/订单排产报表/getPageBySaleOrderUsingPOST
*/
export default function fetchMethod(options: { data: IProductionSchedulingOrderSearchVO }, extraOptions?: any) {
    return http<IJSONResultPageInformationSchedulingOrderReportVOSalesSingleDimension>(
        {
            url: "/app-enterprise-web/api/app/enterprise/produceOrderScheduleReport/getPageBySaleOrder",
            method: "post",
            ...options,
        },
        extraOptions,
...
export interface IPageInformationSchedulingOrderReportVOSalesSingleDimension {
    ...
    lastPage?: number;
    /** 是否有上一页 */
    hasPreviousPage?: EPageInformationSchedulingOrderReportVOSalesSingleDimension_hasPreviousPage;
    /** 是否有下一页 */
    hasNextPage?: EPageInformationSchedulingOrderReportVOSalesSingleDimension_hasNextPage;
    /** 上一页页码 */
    previousPage?: number;
    /** 下一页页码 */
    nextPage?: number;
...
export enum EPageInformationSchedulingOrderReportVOSalesSingleDimension_hasPreviousPage {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EPageInformationSchedulingOrderReportVOSalesSingleDimension_hasNextPage {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
