...
/**
* @link http://47.108.139.107:16400/doc.html#/default/模具相关/getFlowPathStructureDataUsingPOST_21
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/mold/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
