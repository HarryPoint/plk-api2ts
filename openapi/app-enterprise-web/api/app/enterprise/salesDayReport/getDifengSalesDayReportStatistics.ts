...
/**
* @link http://47.108.139.107:16400/doc.html#/default/销售日报表相关/getDifengSalesDayReportStatisticsUsingPOST
*/
export default function fetchMethod(data: GetDifengSalesDayReportStatistics, extraOptions?: any) {
    return http<IJSONResultIndicatesTheReturnedObjectOfDailySalesReportStatistics>(
        {
            url: "/app-enterprise-web/api/app/enterprise/salesDayReport/getDifengSalesDayReportStatistics",
            method: "post",
            data,
        },
        extraOptions,
