...
/**
* @link http://47.108.139.107:16400/doc.html#/default/工序相关/getFlowPathStructureDataUsingPOST_23
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/process/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
