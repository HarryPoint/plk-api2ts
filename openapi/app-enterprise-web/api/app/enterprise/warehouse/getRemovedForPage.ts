...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/仓位相关/getRemovedForPageUsingPOST_22
*/
export default function fetchMethod(options: { data: IProcessDataBaseSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/warehouse/getRemovedForPage",
            method: "POST",
            ...options,
        },
        extraOptions,
