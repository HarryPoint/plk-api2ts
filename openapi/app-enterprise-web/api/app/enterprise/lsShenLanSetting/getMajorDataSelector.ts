...
/**
* @link http://47.108.139.107:16400/doc.html#/default/深蓝大屏相关/getMajorDataSelectorUsingPOST_8
*/
export default function fetchMethod(options: { data: IMaterialMasterDataSelectionListSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationMaterialMasterDataSelectionReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/lsShenLanSetting/getMajorDataSelector",
            method: "post",
            ...options,
        },
        extraOptions,
