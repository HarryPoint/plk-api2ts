...
// http://47.108.139.107:16400/doc.html#/default/生产订单相关/batchGetProducePrintTagUsingPOST
export default function fetchMethod(data: number[]) {
    return post<IJSONResultListProducePrintTagVO['data']>({
      url: "/app-enterprise-web/api/app/enterprise/produceOrder/producePrintTag/batchGet",
      data,
    });
}
