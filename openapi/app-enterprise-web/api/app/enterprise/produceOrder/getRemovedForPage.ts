...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/生产订单相关/getRemovedForPageUsingPOST_16
*/
export default function fetchMethod(options: { data: IProcessDataBaseSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/produceOrder/getRemovedForPage",
            method: "POST",
            ...options,
        },
        extraOptions,
