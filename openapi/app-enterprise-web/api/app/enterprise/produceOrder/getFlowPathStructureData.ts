...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/生产订单相关/getFlowPathStructureDataUsingPOST_24
*/
...
export interface IProductionOrderDynamicDataVO {
    ...
    flowPathCode?: string;
    /** 是否自定义提交按钮文案 */
    isCustomSubmitContent?: EProductionOrderDynamicDataVO_isCustomSubmitContent;
    /** 自定义提交按钮文案 */
...
export enum EProductionOrderDynamicDataVO_isCustomSubmitContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
