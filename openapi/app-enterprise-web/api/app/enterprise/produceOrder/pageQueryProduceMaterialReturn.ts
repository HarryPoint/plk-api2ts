...
// http://47.108.139.107:16400/doc.html#/default/生产订单相关/pageQueryProduceMaterialReturnUsingPOST
export default function fetchMethod(data: IPaging8) {
    return post<IProduceMaterialReturnQueryResponseDTOJSONResultPagingInformation['data']>({
