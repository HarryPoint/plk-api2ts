...
/**
* @author Tan Peng
* @link http://47.108.135.148:16400/doc.html#/default/工序完成明细表/querySumDataUsingPOST
*/
export default function fetchMethod(options: { data: IProcedureCompletionListQuery }, extraOptions?: any) {
    return http<IJSONResultProcessCompletionDetailsTotalResponseDto>(
        {
            url: "/app-enterprise-web/api/app/enterprise/processCompleteDetailReport/querySumData",
            method: "POST",
            ...options,
        },
        extraOptions,
