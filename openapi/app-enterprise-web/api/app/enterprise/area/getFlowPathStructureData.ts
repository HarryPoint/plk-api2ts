...
/**
* @link http://47.108.139.107:16400/doc.html#/default/区域相关/getFlowPathStructureDataUsingPOST_1
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/area/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
