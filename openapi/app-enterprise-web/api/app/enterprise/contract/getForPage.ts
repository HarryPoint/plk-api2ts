...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/CRM-合同管理相关/getPageByFlowPathIdUsingPOST_1
*/
export default function fetchMethod(options: { data: IProcessDataBaseSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/contract/getForPage",
            method: "POST",
            ...options,
        },
        extraOptions,
