...
// http://47.108.139.107:16400/doc.html#/default/质检方案/getByIdUsingGET_18
export default function fetchMethod(params: { id?: number }) {
    return get<IJSONResultCheckSolutionDetailsAreReturnedToVO['data']>({
      url: "/app-enterprise-web/api/app/enterprise/qualityInspectionPlan/getById",
      params,
    });
}
