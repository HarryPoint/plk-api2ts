...
/**
* @link http://47.108.139.107:16400/doc.html#/default/订单进度统计报表相关/getMajorDataSelectorUsingPOST_19
*/
export default function fetchMethod(data: IMaterialMasterDataSelectionListSearchVO, extraOptions?: any) {
    return http<IJSONResultPagingInformationMaterialMasterDataSelectionReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/salesOrderReport/getMajorDataSelector",
            method: "post",
            data,
        },
        extraOptions,
