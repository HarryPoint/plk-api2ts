...
/**
* @author 
* @link http://47.108.139.107:16400/doc.html#/default/待办相关/getDetailByIdUsingGET_4
*/
...
export interface IProcessTaskDetailsAreReturnedToVO {
    ...
    backFlowPathNodeSelector?: IIdNameNumberVO3[];
    /** 下个节点的选择集合 - 是否开启审批人选择框，通过判断 approverFrom == PREVIOUS_NODE_ASSIGNMENT */
    nextNodeSelector?: IIdNameNumberVO3[];
    /** 是否自定义接受按钮文案 */
...
/** Id，名称，编号VO_3 */
export interface IIdNameNumberVO3 {
    /** 审批人来自 */
    approverFrom?: EIdNameNumberVO3_approverFrom;
    /** id */
    id: string;
    /** 名称 */
    name: string;
...
export enum EIdNameNumberVO3_approverFrom {
    /** 当前节点指定 */
