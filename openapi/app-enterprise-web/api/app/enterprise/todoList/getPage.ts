...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/待办相关/getPageUsingPOST_35
*/
export default function fetchMethod(options: { data: IToDoListSearchVO }, extraOptions?: any) {
    return http<IJSONResultPageInformationBacklogReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/todoList/getPage",
            method: "POST",
            ...options,
        },
        extraOptions,
...
export interface IBacklogReturnsToVO {
    ...
    /** 是否超时 */
    isTimeout?: EBacklogReturnsToVO_isTimeout;
    /** 待办业务类型 */
    businessType?: EBacklogReturnsToVO_businessType;
    /** 生产任务是否为返工 */
    produceTaskIsBack?: EBacklogReturnsToVO_produceTaskIsBack;
    /** 当前完成数量 */
    ...
    /** 是否能跳转 */
    canRedirect?: EBacklogReturnsToVO_canRedirect;
    /** pc端跳转路径 */
    webPath?: string;
    /** 移动端跳转路径 */
    mobilePath?: string;
    /** 生产任务状态 */
    produceTaskStatus?: EBacklogReturnsToVO_produceTaskStatus;
    /** 生产任务状态描述 */
    produceTaskStatusDesc?: string;
    /** 质检任务状态 */
    qualityTaskStatus?: EBacklogReturnsToVO_qualityTaskStatus;
    /** 质检任务状态描述 */
...
export enum EPageInformationBacklogReturnsVO_hasPreviousPage {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EPageInformationBacklogReturnsVO_hasNextPage {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EBacklogReturnsToVO_type {
    /** 由我处理 */
...
export enum EBacklogReturnsToVO_status {
    /** 待处理 */
    NOT_HANDLE = "NOT_HANDLE",
    /** 未读 */
    NOT_READ = "NOT_READ",
...
export enum EBacklogReturnsToVO_isTimeout {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EBacklogReturnsToVO_businessType {
    /** 待办 */
    TODO = "TODO",
    /** 生产任务 */
...
export enum EBacklogReturnsToVO_produceTaskIsBack {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EBacklogReturnsToVO_canRedirect {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EBacklogReturnsToVO_produceTaskStatus {
    /** 待处理 */
    WAIT = "WAIT",
    /** 生产中 */
    PRODUCE = "PRODUCE",
...
export enum EBacklogReturnsToVO_qualityTaskStatus {
    /** 待质检 */
    WAIT = "WAIT",
    /** 已完成 */
    COMPLETE = "COMPLETE",
