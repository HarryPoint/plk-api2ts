...
/**
* @author 
* @link http://47.108.139.107:16400/doc.html#/default/CRM-工作日报相关/getWorkOrderLogUsingPOST_10
*/
export default function fetchMethod(options: { data: IJobLogSearchVO }, extraOptions?: any) {
    return http<IJSONResultThePageInformationWorkOrderLogReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/dailyWork/getWorkOrderLog",
            method: "POST",
            ...options,
        },
        extraOptions,
