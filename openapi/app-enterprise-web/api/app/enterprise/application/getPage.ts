...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/应用相关/getPageUsingPOST
*/
export default function fetchMethod(options: { data: IProcessSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationFlowRespondsToVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/application/getPage",
            method: "POST",
            ...options,
        },
        extraOptions,
...
export enum EThePagingInformationFlowRespondsToVO_hasPreviousPage {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EThePagingInformationFlowRespondsToVO_hasNextPage {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
