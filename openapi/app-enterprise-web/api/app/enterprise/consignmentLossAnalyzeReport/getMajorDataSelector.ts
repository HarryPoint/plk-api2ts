...
/**
* @link http://47.108.139.107:16400/doc.html#/default/宝晶寄售损耗报表相关/getMajorDataSelectorUsingPOST_2
*/
export default function fetchMethod(options: { data: IMaterialMasterDataSelectionListSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationMaterialMasterDataSelectionReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/consignmentLossAnalyzeReport/getMajorDataSelector",
            method: "post",
            ...options,
        },
        extraOptions,
