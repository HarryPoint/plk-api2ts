...
/**
* @link http://47.108.139.107:16400/doc.html#/default/CRM-跟进计划相关/getPageByFlowPathIdUsingPOST_6
*/
export default function fetchMethod(data: IProcessDataBaseSearchVO, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/followPlan/getForPage",
            method: "post",
            data,
        },
        extraOptions,
