...
/**
* @link http://47.108.139.107:16400/doc.html#/default/报废统计/getMajorDataSelectorUsingPOST_7
*/
export default function fetchMethod(options: { data: IMaterialMasterDataSelectionListSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationMaterialMasterDataSelectionReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/baoJingReportScrap/getMajorDataSelector",
            method: "post",
            ...options,
        },
        extraOptions,
