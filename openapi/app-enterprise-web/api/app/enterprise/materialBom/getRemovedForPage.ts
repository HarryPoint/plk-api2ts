...
/**
* @link http://47.108.139.107:16400/doc.html#/default/物料bom相关/getRemovedForPageUsingPOST_11
*/
export default function fetchMethod(data: IProcessDataBaseSearchVO, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/materialBom/getRemovedForPage",
            method: "post",
            data,
        },
        extraOptions,
