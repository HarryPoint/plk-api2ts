...
/**
* @author Tan Peng
* @link http://47.108.139.107:16400/doc.html#/default/物料bom相关/getMaterialDefaultByMaterialIdUsingGET
*/
export default function fetchMethod(options: { params: { materialId?: string } }, extraOptions?: any) {
    return http<IJSONResultBomResponseObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/materialBom/getMaterialDefaultByMaterialId",
            method: "GET",
            ...options,
        },
        extraOptions,
