...
// http://47.108.139.107:16400/doc.html#/default/物料bom相关/listByMaterialIdAndMaterialBomIdUsingGET
export default function fetchMethod(params: { materialBomId: number; materialId: number }) {
    return get<IJSONResultListMaterialBomResponseObject['data']>({
      url: "/app-enterprise-web/api/app/enterprise/materialBom/listByMaterialId",
      params,
    });
}
