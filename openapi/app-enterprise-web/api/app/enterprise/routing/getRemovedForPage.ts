...
/**
* @link http://47.108.139.107:16400/doc.html#/default/工艺路径相关/getRemovedForPageUsingPOST_17
*/
export default function fetchMethod(options: { data: IProcessDataBaseSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-enterprise-web/api/app/enterprise/routing/getRemovedForPage",
            method: "post",
            ...options,
        },
        extraOptions,
