...
/**
* @author helin
* @link http://47.108.139.107:16400/doc.html#/default/企业路由相关/queryFavoritesOfQhseUsingPOST
*/
export default function fetchMethod(options: { data: IEnterpriseRoutingCollectionQueryRequestDTO }, extraOptions?: any) {
    return http<IJSONResultListTheUserCollectsTheEnterpriseRoutingDTO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/routing/queryFavoritesOfQhse",
            method: "POST",
            ...options,
        },
        extraOptions,
