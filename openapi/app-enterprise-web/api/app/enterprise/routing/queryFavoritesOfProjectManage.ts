...
/**
* @link http://47.108.139.107:16400/doc.html#/default/企业路由相关/queryFavoritesOfProjectManageUsingPOST
*/
export default function fetchMethod(options: { data: IEnterpriseRoutingCollectionQueryRequestDTO }, extraOptions?: any) {
    return http<IJSONResultListTheUserCollectsTheEnterpriseRoutingDTO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/routing/queryFavoritesOfProjectManage",
            method: "post",
            ...options,
        },
        extraOptions,
...
/** 企业路由收藏查询请求 DTO */
export interface IEnterpriseRoutingCollectionQueryRequestDTO {
    /** 客户端组编码 */
    clientGroupCode?: string;
}
/** JSONResult«List«用户收藏企业路由 DTO»» */
export interface IJSONResultListTheUserCollectsTheEnterpriseRoutingDTO {
    /** 返回码 */
    code?: number;
    /** 返回消息说明 */
    msg?: string;
    /** 响应结果 */
    data?: ITheUserCollectsTheEnterpriseRouteDTO[];
