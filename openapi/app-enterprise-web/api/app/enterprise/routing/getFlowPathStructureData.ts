...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/工艺路径相关/getFlowPathStructureDataUsingPOST_29
*/
...
export interface IProcessPathDynamicDataVO {
    ...
    flowPathCode?: string;
    /** 是否自定义提交按钮文案 */
    isCustomSubmitContent?: EProcessPathDynamicDataVO_isCustomSubmitContent;
    /** 自定义提交按钮文案 */
...
export enum EProcessPathDynamicDataVO_isCustomSubmitContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
