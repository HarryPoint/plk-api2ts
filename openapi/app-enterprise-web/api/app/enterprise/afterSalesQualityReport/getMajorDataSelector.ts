...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/宝晶售后质量分析报表相关/getMajorDataSelectorUsingPOST
*/
export default function fetchMethod(options: { data: IMaterialMasterDataSelectionListSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationMaterialMasterDataSelectionReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/afterSalesQualityReport/getMajorDataSelector",
            method: "POST",
            ...options,
        },
        extraOptions,
