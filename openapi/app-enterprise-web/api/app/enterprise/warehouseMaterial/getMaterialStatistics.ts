...
/**
* @link http://47.108.139.107:16400/doc.html#/default/库存查询相关/getMaterialStatisticsUsingPOST_1
*/
export default function fetchMethod(options: { data: IMaterialMasterDataInventorySearchVO }, extraOptions?: any) {
    return http<IJSONResultMaterialInventoryStatisticsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/warehouseMaterial/getMaterialStatistics",
            method: "post",
            ...options,
        },
        extraOptions,
