...
/**
* @link http://47.108.139.107:16400/doc.html#/default/设备相关/getFlowPathStructureDataUsingPOST_12
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/device/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
