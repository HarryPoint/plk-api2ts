...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/设备数采数据参数相关/getPageUsingPOST_4
*/
export default function fetchMethod(options: { data: IDeviceDataParametersOverviewSearchForVO }, extraOptions?: any) {
