...
// http://47.108.139.107:16400/doc.html#/default/仓库盘点任务相关/getWarehouseTreeListUsingPOST_1
export default function fetchMethod(data: IDatabaseBitTreeQueryVO) {
    return post<IJSONResultListThePositionTreeReturnsVO3['data']>({
