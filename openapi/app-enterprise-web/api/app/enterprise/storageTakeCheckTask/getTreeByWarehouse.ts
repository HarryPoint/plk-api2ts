...
// http://47.108.139.107:16400/doc.html#/default/仓库盘点任务相关/getTreeByWarehouseUsingGET_1
export default function fetchMethod(params: { storehouseId: string }) {
    return get<IJSONResultListPositionTreeReturnsVO2['data']>({
