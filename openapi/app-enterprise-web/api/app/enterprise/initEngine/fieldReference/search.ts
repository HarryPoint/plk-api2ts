...
/**
* @author 
* @link http://47.108.135.148:16400/doc.html#/default/初始化引擎/searchRelationFormDataUsingPOST
*/
export default function fetchMethod(options: { data: ITheFieldRefersToTheQueryCondition }, extraOptions?: any) {
