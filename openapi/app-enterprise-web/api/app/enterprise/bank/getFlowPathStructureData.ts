...
/**
* @link http://47.108.139.107:16400/doc.html#/default/银行相关/getFlowPathStructureDataUsingPOST_2
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/bank/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
