...
/**
* @link http://47.108.139.107:16400/doc.html#/default/改善类别相关/getWorkOrderLogUsingPOST_16
*/
export default function fetchMethod(options: { data: IJobLogSearchVO }, extraOptions?: any) {
    return http<IJSONResultThePageInformationWorkOrderLogReturnsVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/improvementCategory/getWorkOrderLog",
            method: "post",
            ...options,
        },
        extraOptions,
