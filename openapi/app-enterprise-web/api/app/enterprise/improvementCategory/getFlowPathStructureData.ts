...
/**
* @link http://47.108.139.107:16400/doc.html#/default/改善类别相关/getFlowPathStructureDataUsingPOST_16
*/
export default function fetchMethod(data: IProcessStructureSearchVO, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-enterprise-web/api/app/enterprise/improvementCategory/getFlowPathStructureData",
            method: "post",
            data,
        },
        extraOptions,
