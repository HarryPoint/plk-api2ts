...
/**
* @author XieJian
* @link http://47.108.135.148:16400/doc.html#/default/流程数据相关/getDataByCodeOrNameListUsingPOST
*/
export default function fetchMethod(options: { data: IProcessFormCodeOrNameSearchesForVO }, extraOptions?: any) {
