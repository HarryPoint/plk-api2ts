...
// http://47.108.139.107:16400/doc.html#/default/流程数据相关/getFormRpDataForPageUsingPOST
export default function fetchMethod(data: IProcessAssociationFormSearchVO) {
    return post<IJSONResultProcessAssociationFormQueryReturnsVO['data']>({
      url: "/app-enterprise-web/api/app/enterprise/flowPathData/getFormRpDataForPage",
      data,
    });
}
// 流程关联表单搜索VO
