...
/**
* @link http://47.108.139.107:17400/doc.html#/default/工艺路径相关/getFlowPathStructureDataUsingPOST_29
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/routing/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
