...
/**
* @link http://47.108.139.107:17400/doc.html#/default/项目任务相关/getFlowPathStructureDataUsingPOST_19
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/kaizenProjectTask/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
