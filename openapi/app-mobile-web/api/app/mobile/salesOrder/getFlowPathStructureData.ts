...
/**
* @link http://47.108.139.107:17400/doc.html#/default/销售订单相关/getFlowPathStructureDataUsingPOST_30
*/
export default function fetchMethod(data: IProcessStructureSearchVO, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/salesOrder/getFlowPathStructureData",
            method: "post",
            data,
        },
        extraOptions,
