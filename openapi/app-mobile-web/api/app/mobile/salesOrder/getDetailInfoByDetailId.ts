...
// http://47.108.139.107:17400/doc.html#/default/销售订单相关/getDetailInfoByDetailIdUsingGET
export default function fetchMethod(params: { detailId: string }, extraOptions?: any) {
    return http<IJSONResultSalesOrderDetailsBackToVO>(
        {
            url: "/app-mobile-web/api/app/mobile/salesOrder/getDetailInfoByDetailId",
            method: "get",
            params,
        },
        extraOptions,
...
export interface IOtherMaterialInformationRequiredForProductionVO {
    // 替换物料集
    changeMajorDatas: ISubMaterialProductionInformationVO[];
    // 物料bom明细id
    materialBomDetailId: number;
    // 物料id
    materialId: number;
