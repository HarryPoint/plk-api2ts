...
/**
* @link http://47.108.139.107:17400/doc.html#/default/销售订单相关/doBatchTransferToProduceOrderUsingPOST
*/
export default function fetchMethod(options: { data: IBatchTransferToProductionOrder }, extraOptions?: any) {
    return http<IJSONResultSalesOrderToProductionOrderReturnedToDTO>(
        {
            url: "/app-mobile-web/api/app/mobile/salesOrder/transferToProduceOrder/do",
            method: "post",
            ...options,
        },
        extraOptions,
