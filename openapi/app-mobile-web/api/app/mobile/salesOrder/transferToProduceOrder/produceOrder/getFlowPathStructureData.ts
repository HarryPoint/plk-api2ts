...
/**
* @link http://47.108.139.107:17400/doc.html#/default/销售订单相关/getProduceOrderFlowPathStructureDataUsingGET
*/
export default function fetchMethod(options: {} = {}, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/salesOrder/transferToProduceOrder/produceOrder/getFlowPathStructureData",
            method: "get",
            ...options,
        },
        extraOptions,
