...
/**
* @author 
* @link http://47.108.139.107:17400/doc.html#/default/物料相关/getFlowPathStructureDataUsingPOST_21
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/material/getFlowPathStructureData",
            method: "POST",
            ...options,
        },
        extraOptions,
