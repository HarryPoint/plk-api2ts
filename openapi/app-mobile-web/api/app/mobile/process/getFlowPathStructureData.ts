...
/**
* @link http://47.108.139.107:17400/doc.html#/default/工序相关/getFlowPathStructureDataUsingPOST_24
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/process/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
