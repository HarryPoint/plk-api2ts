...
/**
* @author 
* @link http://47.108.135.148:17400/doc.html#/default/设备数采数据方案参数关联相关/getParamDetailByDeviceIdUsingGET
*/
export default function fetchMethod(options: { params: { deviceId?: string } }, extraOptions?: any) {
