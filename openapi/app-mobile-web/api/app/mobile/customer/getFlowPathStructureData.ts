...
/**
* @link http://47.108.139.107:17400/doc.html#/default/客户相关/getFlowPathStructureDataUsingPOST_7
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/customer/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
