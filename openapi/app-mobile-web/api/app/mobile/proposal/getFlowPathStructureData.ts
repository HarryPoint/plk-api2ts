...
/**
* @link http://47.108.139.107:17400/doc.html#/default/合理化建议相关/getFlowPathStructureDataUsingPOST_25
*/
export default function fetchMethod(data: IProcessStructureSearchVO, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/proposal/getFlowPathStructureData",
            method: "post",
            data,
        },
        extraOptions,
