...
/**
* @link http://47.108.139.107:17400/doc.html#/default/仓库相关/getFlowPathStructureDataUsingPOST_32
*/
export default function fetchMethod(data: IProcessStructureSearchVO, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/storehouse/getFlowPathStructureData",
            method: "post",
            data,
        },
        extraOptions,
