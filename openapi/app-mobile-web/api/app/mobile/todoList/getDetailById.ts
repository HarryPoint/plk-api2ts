...
/**
* @link http://47.108.139.107:17400/doc.html#/default/待办相关/getDetailByIdUsingGET
*/
export default function fetchMethod(options: { params: { id?: number } }, extraOptions?: any) {
    return http<IJSONResultProcessTaskDetailsAreReturnedToVO>(
        {
            url: "/app-mobile-web/api/app/mobile/todoList/getDetailById",
            method: "get",
            ...options,
        },
        extraOptions,
...
export interface IProcessTaskDetailsAreReturnedToVO {
    ...
    backFlowPathNodeSelector?: IIdNameNumberVO1[];
    /** 下个节点的选择集合 - 是否开启审批人选择框，通过判断 approverFrom == PREVIOUS_NODE_ASSIGNMENT */
    nextNodeSelector?: IIdNameNumberVO1[];
    /** 是否自定义接受按钮文案 */
    ...
    businessId?: number;
    /** 任务类型 */
    taskType?: EProcessTaskDetailsAreReturnedToVO_taskType;
    /** 任务接受状态 */
    ...
    flowPathCode?: string;
    /** 系统流程类型 */
    flowPathSystemType?: EProcessTaskDetailsAreReturnedToVO_flowPathSystemType;
    /** 流程id */
    flowPathId?: number;
    /** 流程节点id */
    ...
    /** 是否启用转交 */
    enabledTransfer?: EProcessTaskDetailsAreReturnedToVO_enabledTransfer;
    /** 自定义转交按钮文案 */
    customTransferContent?: string;
    /** 转交人员范围 */
    transferScopeType?: EProcessTaskDetailsAreReturnedToVO_transferScopeType;
    /** 是否启用表单暂存 */
    enableFormStaging?: EProcessTaskDetailsAreReturnedToVO_enableFormStaging;
    /** 自定义表单暂存文本 */
    customFormStagingContent?: string;
    /** 是否自定义流程开始按钮文案 */
    isCustomBeginningContent?: EProcessTaskDetailsAreReturnedToVO_isCustomBeginningContent;
    /** 自定义流程开始按钮文案 */
    customBeginningContent?: string;
    /** 是否显示开始按钮 */
    isShowBeginningButton?: EProcessTaskDetailsAreReturnedToVO_isShowBeginningButton;
    /** 是否启用流程开始超时 */
    isEnabledBeginningTimeout?: EProcessTaskDetailsAreReturnedToVO_isEnabledBeginningTimeout;
    /** 状态 */
...
export interface IIdNameNumberVO1 {
    /** 审批人来自 */
    approverFrom?: EIdNameNumberVO1_approverFrom;
    /** id */
    id: number;
    /** 名称 */
    name: string;
...
export enum EProcessTaskDetailsAreReturnedToVO_taskType {
    /** 执行任务 */
    EXECUTE = "EXECUTE",
    /** 审批任务 */
    APPROVAL = "APPROVAL"
...
export enum EProcessTaskDetailsAreReturnedToVO_flowPathSystemType {
    /** 仓库 */
...
export enum EProcessTaskDetailsAreReturnedToVO_enabledTransfer {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessTaskDetailsAreReturnedToVO_transferScopeType {
    /** 指定范围 */
...
export enum EProcessTaskDetailsAreReturnedToVO_enableFormStaging {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessTaskDetailsAreReturnedToVO_isCustomBeginningContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessTaskDetailsAreReturnedToVO_isShowBeginningButton {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessTaskDetailsAreReturnedToVO_isEnabledBeginningTimeout {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EIdNameNumberVO1_approverFrom {
    /** 当前节点指定 */
