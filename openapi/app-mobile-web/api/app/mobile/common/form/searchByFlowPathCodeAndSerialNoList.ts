...
// http://47.108.139.107:17400/doc.html#/default/公共相关/searchByFlowPathCodeAndSerialNoListUsingPOST
export default function fetchMethod(data: IDynamicFormQuery, extraOptions?: any) {
    return http<IJSONResultDynamicFormQueryOutputVO>(
        {
            url: "/app-mobile-web/api/app/mobile/common/form/searchByFlowPathCodeAndSerialNoList",
            method: "post",
            data,
        },
        extraOptions,
