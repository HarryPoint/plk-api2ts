...
/**
* @author 
* @link http://47.108.135.148:17400/doc.html#/default/生产任务相关/moveOutUsingPOST
*/
export default function fetchMethod(options: { data: IInboundAndOutboundInformationDTO }, extraOptions?: any) {
    return http<IJSONResultobject>(
        {
            url: "/app-mobile-web/api/app/mobile/produceTask/moveOut",
            method: "POST",
            ...options,
        },
        extraOptions,
