...
/**
* @author 
* @link http://47.108.139.107:17400/doc.html#/default/生产任务相关/queryMoveOutProduceTaskByProcessIdUsingPOST
*/
export default function fetchMethod(options: { data: IProductionTaskQueryDTOForMobileEnd }, extraOptions?: any) {
    return http<IJSONResultPageInformationProductionTaskResponseDTOForMobile>(
        {
            url: "/app-mobile-web/api/app/mobile/produceTask/queryMoveOutProduceTaskByProcessId",
            method: "POST",
            ...options,
        },
        extraOptions,
