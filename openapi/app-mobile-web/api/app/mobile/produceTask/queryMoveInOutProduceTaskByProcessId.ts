...
/**
* @author 
* @link http://47.108.135.148:17400/doc.html#/default/生产任务相关/queryMoveInOutProduceTaskByProcessIdUsingPOST
*/
export default function fetchMethod(options: { data: IProductionTaskQueryDTOForMobileEnd }, extraOptions?: any) {
    return http<IJSONResultPageInformationProductionTaskResponseDTOForMobile>(
        {
            url: "/app-mobile-web/api/app/mobile/produceTask/queryMoveInOutProduceTaskByProcessId",
            method: "POST",
            ...options,
        },
        extraOptions,
