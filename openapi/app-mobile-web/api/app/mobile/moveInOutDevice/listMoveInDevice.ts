...
// http://47.108.139.107:17400/doc.html#/default/进出料设备相关/listMoveInDeviceUsingPOST
export default function fetchMethod(data: IFeedEquipmentQueryDTO, extraOptions?: any) {
    return http<IJSONResultListFeedDeviceRespondsToDTO>(
        {
            url: "/app-mobile-web/api/app/mobile/moveInOutDevice/listMoveInDevice",
            method: "post",
            data,
        },
        extraOptions,
