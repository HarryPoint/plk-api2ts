...
export default function fetchMethod(data: IExampleQueryTheDataDTOReportedByAUser) {
    return post<IJSONResultPagingInformationDeviceDataCollectionManualReportedDataCDRPagingInformationReturnedToVO['data']>({
