...
/**
* @author XieJian
* @link http://47.108.135.148:17400/doc.html#/default/仓位系统应用库存批次号相关/getWarehouseStorageSystemApplicationByLotNoListUsingPOST
*/
export default function fetchMethod(options: { data: ITheWarehouseSystemAppliesTheInventoryBatchNumberToQueryTheObject }, extraOptions?: any) {
    return http<IJSONResultListTheWarehouseSystemAppliesTheInventoryBatchNumberToThePagingReturnObject>(
        {
            url: "/app-mobile-web/api/app/mobile/warehouseStorageSystemApplicationLotNo/getByLotNoList",
            method: "POST",
            ...options,
        },
        extraOptions,
