...
/**
* @link http://47.108.139.107:17400/doc.html#/default/职位相关/getFlowPathStructureDataUsingPOST_23
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/position/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
