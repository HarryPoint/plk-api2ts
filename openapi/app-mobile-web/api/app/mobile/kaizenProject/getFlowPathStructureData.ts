...
/**
* @author 
* @link http://47.108.135.148:17400/doc.html#/default/项目相关/getFlowPathStructureDataUsingPOST_18
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/kaizenProject/getFlowPathStructureData",
            method: "POST",
            ...options,
        },
        extraOptions,
