...
// http://47.108.139.107:17400/doc.html#/default/改善类别相关/getFlowPathStructureDataUsingPOST_17
export default function fetchMethod(data: IProcessStructureSearchVO, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/improvementCategory/getFlowPathStructureData",
            method: "post",
            data,
        },
        extraOptions,
