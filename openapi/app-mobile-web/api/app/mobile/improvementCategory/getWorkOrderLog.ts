...
/**
* @link http://47.108.139.107:17400/doc.html#/default/改善类别相关/getWorkOrderLogUsingPOST_15
*/
export default function fetchMethod(options: { data: IJobLogSearchVO }, extraOptions?: any) {
    return http<IJSONResultThePageInformationWorkOrderLogReturnsVO>(
        {
            url: "/app-mobile-web/api/app/mobile/improvementCategory/getWorkOrderLog",
            method: "post",
            ...options,
        },
        extraOptions,
