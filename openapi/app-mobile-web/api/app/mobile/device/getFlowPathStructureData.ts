...
/**
* @link http://47.108.139.107:17400/doc.html#/default/设备相关/getFlowPathStructureDataUsingPOST_12
*/
export default function fetchMethod(data: IProcessStructureSearchVO, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/device/getFlowPathStructureData",
            method: "post",
            data,
        },
        extraOptions,
