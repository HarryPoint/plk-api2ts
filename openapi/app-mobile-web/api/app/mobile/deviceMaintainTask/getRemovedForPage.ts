...
/**
* @link http://47.108.139.107:17400/doc.html#/default/设备保养任务相关/getRemovedForPageUsingPOST_7
*/
export default function fetchMethod(options: { data: IProcessDataBaseSearchVO }, extraOptions?: any) {
    return http<IJSONResultPagingInformationJSONObject>(
        {
            url: "/app-mobile-web/api/app/mobile/deviceMaintainTask/getRemovedForPage",
            method: "post",
            ...options,
        },
        extraOptions,
