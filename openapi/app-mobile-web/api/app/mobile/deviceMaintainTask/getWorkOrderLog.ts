...
/**
* @link http://47.108.139.107:17400/doc.html#/default/设备保养任务相关/getWorkOrderLogUsingPOST_12
*/
export default function fetchMethod(options: { data: IJobLogSearchVO }, extraOptions?: any) {
    return http<IJSONResultThePageInformationWorkOrderLogReturnsVO>(
        {
            url: "/app-mobile-web/api/app/mobile/deviceMaintainTask/getWorkOrderLog",
            method: "post",
            ...options,
        },
        extraOptions,
