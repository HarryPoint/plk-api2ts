...
/**
* @link http://47.108.139.107:17400/doc.html#/default/班组相关/getFlowPathStructureDataUsingPOST_4
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultFormStructureVO>(
        {
            url: "/app-mobile-web/api/app/mobile/classGroup/getFlowPathStructureData",
            method: "post",
            ...options,
        },
        extraOptions,
