...
// http://47.108.139.107:17400/doc.html#/default/生产统计相关/getReportHistoryDetailUsingGET
export default function fetchMethod(params: { id: number }) {
    return get<IJSONResultProductionProcessingBasicInformationDetailsAreReturnedToVO['data']>({
      url: "/app-mobile-web/api/app/mobile/produceReport/getReportHistoryDetail",
      params,
    });
}
