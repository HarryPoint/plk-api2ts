...
/**
* @author 
* @link http://47.108.135.148:17400/doc.html#/default/员工相关/getFlowPathStructureDataUsingPOST_14
*/
export default function fetchMethod(options: { data: IProcessStructureSearchVO }, extraOptions?: any) {
    return http<IJSONResultUserDynamicDataResponseDTO>(
        {
            url: "/app-mobile-web/api/app/mobile/employee/getFlowPathStructureData",
            method: "POST",
            ...options,
        },
        extraOptions,
