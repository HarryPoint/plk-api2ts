...
/**
* @author TangYongDi
* @link http://47.108.135.148:18100/doc.html#/default/Saas授权相关/getRouterAndPermissionUsingPOST_1
*/
...
export interface IEnterpriseRoutingTreeQueryDTO1 {
    ...
    /** 查询模式 */
    queryModel?: EEnterpriseRoutingTreeQueryDTO1_queryModel;
    /** 服务对象ID */
...
export interface ITheUserRoutingTreeRespondsToTheDTO {
    ...
    enterpriseId?: string;
    /** 是否存在数据权限 */
    hasDataAuth?: ETheUserRoutingTreeRespondsToTheDTO_hasDataAuth;
    /** 图标 */
    icon?: string;
    /** id */
    id?: string;
    /** 当前用户是否收藏 */
    isFavorite?: ETheUserRoutingTreeRespondsToTheDTO_isFavorite;
    /** 是否系统路由 */
    ...
    sort?: number;
    /** 菜单类型 */
    type?: ETheUserRoutingTreeRespondsToTheDTO_type;
}
/** 企业路由配置响应 DTO */
...
export enum EEnterpriseRoutingTreeQueryDTO1_applicationLevel {
    /** 项目管理 */
...
export enum EEnterpriseRoutingTreeQueryDTO1_queryModel {
    /** 快速模式 */
    QUICK = "QUICK",
    /** 精准模式 */
    PRECISE = "PRECISE"
...
export enum ETheUserRoutingTreeRespondsToTheDTO_hasDataAuth {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheUserRoutingTreeRespondsToTheDTO_isFavorite {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheUserRoutingTreeRespondsToTheDTO_isSystem {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheUserRoutingTreeRespondsToTheDTO_type {
    GROUP = "GROUP",
    PAGE = "PAGE"
}
