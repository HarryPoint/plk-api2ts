...
/**
* @author TangYongDi
* @link http://47.108.135.148:18100/doc.html#/default/权限相关/editUsingPOST
*/
...
export interface IPermissionAddedTheDTO {
    ...
    parentCode?: string;
    /** 权限类型 */
    type: EPermissionAddedTheDTO_type;
    /** 系统应用类型 */
    applicationSystemType?: EPermissionAddedTheDTO_applicationSystemType;
    /** 应用级别 */
    applicationLevel?: EPermissionAddedTheDTO_applicationLevel;
}
/** JSONResult«object» */
...
export enum EPermissionAddedTheDTO_type {
    /** 功能 */
    FUN = "FUN",
    /** 按钮 */
    BUTTON = "BUTTON"
...
export enum EPermissionAddedTheDTO_applicationSystemType {
    /** 仓库 */
...
export enum EPermissionAddedTheDTO_applicationLevel {
    /** 项目管理 */
