...
/**
* @author TangYongDi
* @link http://47.108.135.148:18100/doc.html#/default/权限相关/listTreeUsingPOST_1
*/
export default function fetchMethod(options: { data: IPermissionQuery }, extraOptions?: any) {
...
export interface IThePermissionTreeRespondsToTheDTO {
    /** 应用级别 */
    applicationLevel?: EThePermissionTreeRespondsToTheDTO_applicationLevel;
    /** 系统应用类型 */
    applicationSystemType?: EThePermissionTreeRespondsToTheDTO_applicationSystemType;
    /** 子集 */
    ...
    serveCode?: string;
    /** 权限类型 */
    type?: EThePermissionTreeRespondsToTheDTO_type;
}

export enum EThePermissionTreeRespondsToTheDTO_applicationLevel {
    /** 项目管理 */
...
export enum EThePermissionTreeRespondsToTheDTO_applicationSystemType {
    /** 仓库 */
...
export enum EThePermissionTreeRespondsToTheDTO_type {
    /** 功能 */
    FUN = "FUN",
    /** 按钮 */
    BUTTON = "BUTTON"
