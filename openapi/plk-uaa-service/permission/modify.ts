...
/**
* @author TangYongDi
* @link http://47.108.135.148:18100/doc.html#/default/权限相关/modifyUsingPOST_8
*/
...
export interface IPermissionEditDtos {
    ...
    /** 系统应用类型 */
    applicationSystemType?: EPermissionEditDtos_applicationSystemType;
    /** 权限编码 */
    code: string;
    /** id */
    id?: string;
...
export enum EPermissionEditDtos_applicationLevel {
    /** 项目管理 */
...
export enum EPermissionEditDtos_applicationSystemType {
    /** 仓库 */
