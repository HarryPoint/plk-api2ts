...
export default function fetchMethod(data: IEnterpriseRoutingCollectionQueryRequestDTO) {
    return post<IJSONResultListTheUserCollectsTheEnterpriseRoutingDTO['data']>({
