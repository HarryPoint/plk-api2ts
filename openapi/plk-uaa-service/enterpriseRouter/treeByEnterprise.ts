...
/**
* @author TangYongDi
* @link http://47.108.135.148:18100/doc.html#/default/企业路由相关/treeByEnterpriseUsingPOST
*/
...
export interface IQueryDTO2InTheEnterpriseRoutingTree {
    /** 应用级别 */
    applicationLevel?: EQueryDTO2InTheEnterpriseRoutingTree_applicationLevel;
    /** 客户端组编码 */
    ...
    /** 查询模式 */
    queryModel?: EQueryDTO2InTheEnterpriseRoutingTree_queryModel;
    /** 服务对象ID */
...
export interface ITheEnterpriseRoutingTreeRespondsToTheDTO {
    ...
    enterpriseId?: string;
    /** 是否存在数据权限 */
    hasDataAuth?: ETheEnterpriseRoutingTreeRespondsToTheDTO_hasDataAuth;
    /** 图标 */
    icon?: string;
    /** id */
    id?: string;
    ...
    sort?: number;
    /** 菜单类型 */
    type?: ETheEnterpriseRoutingTreeRespondsToTheDTO_type;
}
/** 企业路由配置响应 DTO */
...
export enum EQueryDTO2InTheEnterpriseRoutingTree_applicationLevel {
    /** 项目管理 */
...
export enum EQueryDTO2InTheEnterpriseRoutingTree_queryModel {
    /** 快速模式 */
    QUICK = "QUICK",
    /** 精准模式 */
    PRECISE = "PRECISE"
...
export enum ETheEnterpriseRoutingTreeRespondsToTheDTO_hasDataAuth {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheEnterpriseRoutingTreeRespondsToTheDTO_isSystem {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ETheEnterpriseRoutingTreeRespondsToTheDTO_type {
    GROUP = "GROUP",
    PAGE = "PAGE"
}
