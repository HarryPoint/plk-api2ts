...
/**
* @author TangYongDi
* @link http://47.108.135.148:18100/doc.html#/default/企业路由相关/listAllLevelUsingPOST
*/
export default function fetchMethod(options: { data: IEnterpriseRoutingTreeQueryDTO1 }, extraOptions?: any) {
    return http<IJSONResultListEnterpriseRouteResponseDTO>(
        {
            url: "/plk-uaa-service/enterpriseRouter/listAllLevel",
            method: "POST",
            ...options,
        },
        extraOptions,
...
/** JSONResult«List«企业路由响应 DTO»» */
export interface IJSONResultListEnterpriseRouteResponseDTO {
    /** 返回码 */
    code?: number;
    /** 响应结果 */
