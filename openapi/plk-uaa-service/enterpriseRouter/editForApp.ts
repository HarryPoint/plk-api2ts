...
/**
* @author TangYongDi
* @link http://47.108.135.148:18100/doc.html#/default/企业路由相关/editForAppUsingPOST
*/
...
export interface IApplyTheEnterpriseRouteEditRequestDTO {
    ...
    appName?: string;
    /** 应用类型 */
    appSystemType?: EApplyTheEnterpriseRouteEditRequestDTO_appSystemType;
    /** 应用级别 */
    applicationLevel?: EApplyTheEnterpriseRouteEditRequestDTO_applicationLevel;
    /** 发布到的企业路由id集 */
    enterpriseRouterPublishRequestList?: IEnterpriseRouterPublishRequestDTO[];
    /** 是否是系统应用 */
    isSystem?: EApplyTheEnterpriseRouteEditRequestDTO_isSystem;
    /** 服务对象Code */
...
export enum EApplyTheEnterpriseRouteEditRequestDTO_appSystemType {
    /** 仓库 */
...
export enum EApplyTheEnterpriseRouteEditRequestDTO_applicationLevel {
    /** 项目管理 */
