...
/**
* @link http://47.108.139.107:18100/doc.html#/default/企业客户相关/queryCanFormalDelayEnterpriseListUsingPOST
*/
export default function fetchMethod(data: IProductOrderEnterpriseQueryRequestObject, extraOptions?: any) {
    return http<IJSONResultListEnterpriseNameNumberResponseObject>(
        {
            url: "/plk-uaa-service/enterprise/queryCanFormalDelayEnterpriseList",
            method: "post",
            data,
        },
        extraOptions,
