...
/**
* @author 
* @link http://47.108.135.148:16500/doc.html#/default/流程表单字段相关/getFlowPathFormFieldByCodeAndFlowPathVersionIdAndCheckUsingGET
*/
export default function fetchMethod(options: { params: { enterpriseId?: string; flowPathVersionId?: string; serialNo?: string } }, extraOptions?: any) {
    return http<IJSONResultProcessFormVO>(
        {
            url: "/flow-service/flowPathFormField/getFlowPathFormFieldByCodeAndFlowPathVersionIdAndCheck",
            method: "GET",
            ...options,
        },
        extraOptions,
...
/** JSONResult«流程表单VO» */
export interface IJSONResultProcessFormVO {
    /** 返回码 */
    code?: number;
    /** 返回消息说明 */
    msg?: string;
