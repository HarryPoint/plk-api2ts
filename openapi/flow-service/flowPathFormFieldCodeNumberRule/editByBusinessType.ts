...
/**
* @author 
* @link http://47.108.135.148:16500/doc.html#/default/流程表单字段编码相关/editByBusinessTypeUsingPOST
*/
...
export interface IBusinessCodingRulesEditDto {
    /** businessType */
    businessType?: EBusinessCodingRulesEditDto_businessType;
    /** 明细 */
...
export enum EBusinessCodingRulesEditDto_businessType {
    /** 生产任务 */
