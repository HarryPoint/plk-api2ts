...
/**
* @author 
* @link http://47.108.135.148:16500/doc.html#/default/流程相关/stagingUsingPOST
*/
...
export interface IProcessEditDTO2 {
    ...
    code?: string;
    /** 应用类型 */
    type?: EProcessEditDTO2_type;
    /** 简介 */
    lastDescription?: string;
    /** 发布终端值合计 */
    lastPublishTotal?: number;
    /** 是否系统级流程 */
    isSystem?: EProcessEditDTO2_isSystem;
    /** 系统流程类型 */
    flowPathSystemType?: EProcessEditDTO2_flowPathSystemType;
    /** 是否是树状应用 */
    isTree?: EProcessEditDTO2_isTree;
    /** 表单集 */
    ...
    /** 流程结果通知 */
    flowPathResultNotify?: EProcessEditDTO2_flowPathResultNotify;
    /** 重新提交通知 */
    recommitNotify?: EProcessEditDTO2_recommitNotify;
    /** 作废停用通知 */
    invalidNotify?: EProcessEditDTO2_invalidNotify;
    /** 删除通知 */
    deleteNotify?: EProcessEditDTO2_deleteNotify;
    /** 应用访问链接 */
    accessUrl?: string;
    /** 代办设置 */
    ...
    /** 应用级别 */
    applicationLevel?: EProcessEditDTO2_applicationLevel;
    /** undefined */
    isInitAppServicePack?: EProcessEditDTO2_isInitAppServicePack;
}
/** 流程表单字段编辑DTO */
...
export interface IProcessNodeEditDTO4 {
    ...
    /** 审批类型 */
    approvalType?: EProcessNodeEditDTO4_approvalType;
    /** 是否允许回退 */
    isBack?: EProcessNodeEditDTO4_isBack;
    /** 回退类型 */
    ...
    /** 是否自定义提交按钮文案 */
    isCustomSubmitContent: EProcessNodeEditDTO4_isCustomSubmitContent;
    /** 自定义提交按钮文案 */
    customSubmitContent?: string;
    /** 是否开启超时设置 */
    enabledTimeout: EProcessNodeEditDTO4_enabledTimeout;
    /** 超时类型 */
    ...
    /** 节点启动方式 */
    launchType: EProcessNodeEditDTO4_launchType;
    /** 执行类型 */
    executeType: EProcessNodeEditDTO4_executeType;
    /** 是否自定义接受按钮文案 */
    isCustomAcceptContent: EProcessNodeEditDTO4_isCustomAcceptContent;
    /** 自定义接受按钮文案 */
    customAcceptContent?: string;
    /** 是否显示流程接受按钮 */
    isShowAcceptButton?: EProcessNodeEditDTO4_isShowAcceptButton;
    /** 是否自定义同意按钮文案 */
    isCustomPassApprovalContent: EProcessNodeEditDTO4_isCustomPassApprovalContent;
    /** 自定义同意按钮文案 */
    customPassApprovalContent?: string;
    /** 是否自定义拒绝按钮文案 */
    isCustomRefuseApprovalContent: EProcessNodeEditDTO4_isCustomRefuseApprovalContent;
    /** 自定义拒绝按钮文案 */
    customRefuseApprovalContent?: string;
    /** 是否显示流程拒绝按钮 */
    isShowRefuseButton?: EProcessNodeEditDTO4_isShowRefuseButton;
    /** 是否自定义回退按钮文案 */
    isCustomBackContent: EProcessNodeEditDTO4_isCustomBackContent;
    /** 自定义回退按钮文案 */
    customBackContent?: string;
    /** 是否显示流程回退按钮 */
    isShowBackButton?: EProcessNodeEditDTO4_isShowBackButton;
    /** 消息配置列表 */
    messageConfigList?: ITheProcessNodeEditsTheDTO[];
    /** 是否启用接受超时 */
    isEnabledAcceptTimeout?: EProcessNodeEditDTO4_isEnabledAcceptTimeout;
    /** 审批人来自, 默认是当前节点审批 */
    approverFrom?: EProcessNodeEditDTO4_approverFrom;
    /** 上一节点限制指定范围 */
    previousNodeAssignmentRange?: EProcessNodeEditDTO4_previousNodeAssignmentRange;
    /** 上一节点选项人员集合 */
    previousNodeUserOptions?: ITheProcessNodeExecutiveEditsTheDTO[];
    /** 是否启用转交 */
    enabledTransfer?: EProcessNodeEditDTO4_enabledTransfer;
    /** 自定义转交按钮文案 */
    customTransferContent?: string;
    /** 转交人员范围 */
    transferScopeType?: EProcessNodeEditDTO4_transferScopeType;
    /** 转交人集 */
    transferUsers?: ITheProcessNodeExecutiveEditsTheDTO[];
    /** 是否启用表单暂存 */
    enableFormStaging?: EProcessNodeEditDTO4_enableFormStaging;
    /** 自定义表单暂存文本 */
    customFormStagingContent?: string;
    /** 是否自定义流程开始按钮文案 */
    isCustomBeginningContent: EProcessNodeEditDTO4_isCustomBeginningContent;
    /** 自定义流程开始按钮文案 */
    customBeginningContent?: string;
    /** 是否显示开始按钮 */
    isShowBeginningButton?: EProcessNodeEditDTO4_isShowBeginningButton;
    /** 是否启用流程开始超时 */
    isEnabledBeginningTimeout?: EProcessNodeEditDTO4_isEnabledBeginningTimeout;
}
/** 流程节点执行人编辑DTO */
...
export enum EProcessEditDTO2_type {
    /** 单据 */
    BILL = "BILL",
    /** 基础数据 */
    DATA = "DATA",
...
export enum EProcessEditDTO2_isSystem {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO2_flowPathSystemType {
    /** 仓库 */
...
export enum EProcessEditDTO2_isTree {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO2_flowPathResultNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO2_recommitNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO2_invalidNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO2_deleteNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO2_applicationLevel {
    /** 项目管理 */
...
export enum EProcessEditDTO2_isInitAppServicePack {
    Y = "Y",
    N = "N"
}
...
export enum EProcessNodeEditDTO4_type {
    /** 执行节点 */
    EXECUTE = "EXECUTE",
    /** 审批节点 */
    APPROVAL = "APPROVAL",
...
export enum EProcessNodeEditDTO4_approvalType {
    /** 一位负责人通过或者拒绝即可 */
    ONE = "ONE",
...
export enum EProcessNodeEditDTO4_isBack {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_backType {
    /** 之前所有节点 */
    ANY = "ANY",
    /** 返回上一节点 */
    PREVIOUS = "PREVIOUS",
...
export enum EProcessNodeEditDTO4_isCustomSubmitContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_enabledTimeout {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_launchType {
    /** 手动 */
...
export enum EProcessNodeEditDTO4_executeType {
    /** 只需一位执行人提交流程 */
    ONE = "ONE",
    /** 需所有执行人提交流程 */
    ALL = "ALL"
...
export enum EProcessNodeEditDTO4_isCustomAcceptContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_isShowAcceptButton {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_isCustomPassApprovalContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_isCustomRefuseApprovalContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_isShowRefuseButton {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_isCustomBackContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_isShowBackButton {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_isEnabledAcceptTimeout {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_approverFrom {
    /** 当前节点指定 */
...
export enum EProcessNodeEditDTO4_previousNodeAssignmentRange {
    /** 不限制 */
    NO_LIMIT = "NO_LIMIT",
    /** 指定限制 */
    LIMIT = "LIMIT"
...
export enum EProcessNodeEditDTO4_enabledTransfer {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_transferScopeType {
    /** 指定范围 */
...
export enum EProcessNodeEditDTO4_enableFormStaging {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_isCustomBeginningContent {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_isShowBeginningButton {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessNodeEditDTO4_isEnabledBeginningTimeout {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
