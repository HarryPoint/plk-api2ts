...
/**
* @author 
* @link http://47.108.135.148:16500/doc.html#/default/流程相关/editUsingPOST_1
*/
...
export interface IProcessEditDTO1 {
    ...
    code?: string;
    /** 应用类型 */
    type?: EProcessEditDTO1_type;
    /** 简介 */
    lastDescription?: string;
    /** 发布终端值合计 */
    lastPublishTotal?: number;
    /** 是否系统级流程 */
    isSystem?: EProcessEditDTO1_isSystem;
    /** 系统流程类型 */
    flowPathSystemType?: EProcessEditDTO1_flowPathSystemType;
    /** 是否是树状应用 */
    isTree?: EProcessEditDTO1_isTree;
    /** 表单集 */
    ...
    /** 流程结果通知 */
    flowPathResultNotify?: EProcessEditDTO1_flowPathResultNotify;
    /** 重新提交通知 */
    recommitNotify?: EProcessEditDTO1_recommitNotify;
    /** 作废停用通知 */
    invalidNotify?: EProcessEditDTO1_invalidNotify;
    /** 删除通知 */
    deleteNotify?: EProcessEditDTO1_deleteNotify;
    /** 应用访问链接 */
    accessUrl?: string;
    /** 代办设置 */
    ...
    /** undefined */
    isInitAppServicePack?: EProcessEditDTO1_isInitAppServicePack;
}
/** 流程表单字段编辑DTO */
...
export enum EProcessEditDTO1_type {
    /** 单据 */
    BILL = "BILL",
    /** 基础数据 */
    DATA = "DATA",
...
export enum EProcessEditDTO1_isSystem {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO1_flowPathSystemType {
    /** 仓库 */
...
export enum EProcessEditDTO1_isTree {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO1_flowPathResultNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO1_recommitNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO1_invalidNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO1_deleteNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessEditDTO1_applicationLevel {
    /** 项目管理 */
...
export enum EProcessEditDTO1_isInitAppServicePack {
    Y = "Y",
    N = "N"
}
