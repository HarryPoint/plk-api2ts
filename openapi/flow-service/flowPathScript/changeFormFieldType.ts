...
*/
export default function fetchMethod(options: { params: { appSystemType?: EappSystemType; enterpriseId?: number; fieldCode?: string; toFormFieldType?: EtoFormFieldType } }, extraOptions?: any) {
