...
*/
export default function fetchMethod(options: { data: IFormFieldOption[]params: { businessCode?: EbusinessCode; enterpriseId?: number; flowPathId?: number } }, extraOptions?: any) {
