...
/**
* @author lin.he
* @link http://47.108.135.148:16500/doc.html#/default/应用服务包相关/getLastByServiceObjectIdUsingGET
*/
...
export interface IApplicationServicePackResponse {
    ...
    /** 创建状态 */
    status?: EApplicationServicePackResponse_status;
    /** 错误消息 */
    errorMsg?: string;
    /** 应用级别 */
    applicationLevel?: EApplicationServicePackResponse_applicationLevel;
}
/** 应用服务包明细响应 */
export interface IApplicationServicePackDetailsResponse {
    ...
    flowPathName?: string;
    /** 系统状态 */
    flowPathSystemType?: EApplicationServicePackDetailsResponse_flowPathSystemType;
    /** 是否默认 */
    isDefault?: EApplicationServicePackDetailsResponse_isDefault;
}

export enum EApplicationServicePackResponse_status {
    /** 已创建 */
    CREATED = "CREATED",
    /** 等待创建 */
    WAITING = "WAITING",
...
export enum EApplicationServicePackResponse_applicationLevel {
    /** 项目管理 */
...
export enum EApplicationServicePackDetailsResponse_flowPathSystemType {
    /** 仓库 */
...
export enum EApplicationServicePackDetailsResponse_isDefault {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
