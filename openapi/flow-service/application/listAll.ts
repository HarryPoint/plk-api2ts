...
/**
* @author TangYongDi
* @link http://47.108.135.148:16500/doc.html#/default/应用相关/listAllUsingPOST
*/
...
export interface IApplyBasicInformationToQueryObjects {
    ...
    /** 应用级别 */
    applicationLevel?: EApplyBasicInformationToQueryObjects_applicationLevel;
}
...
export interface IProcessBasicInformationRespondsToTheDTO {
    ...
    code?: string;
    /** 应用类型 */
    type?: EProcessBasicInformationRespondsToTheDTO_type;
    /** 最新版本号 */
    ...
    /** 是否系统级流程 */
    isSystem?: EProcessBasicInformationRespondsToTheDTO_isSystem;
    /** 系统流程类型 */
    flowPathSystemType?: EProcessBasicInformationRespondsToTheDTO_flowPathSystemType;
    /** 是否是树状应用 */
    isTree?: EProcessBasicInformationRespondsToTheDTO_isTree;
    /** 是否是多流程 */
    isMultiFlow?: EProcessBasicInformationRespondsToTheDTO_isMultiFlow;
    /** 排序 */
    sort?: number;
    /** 流程结果通知 */
    flowPathResultNotify?: EProcessBasicInformationRespondsToTheDTO_flowPathResultNotify;
    /** 重新提交通知 */
    recommitNotify?: EProcessBasicInformationRespondsToTheDTO_recommitNotify;
    /** 作废停用通知 */
    invalidNotify?: EProcessBasicInformationRespondsToTheDTO_invalidNotify;
    /** 删除通知 */
    deleteNotify?: EProcessBasicInformationRespondsToTheDTO_deleteNotify;
    /** 应用访问链接 */
    accessUrl?: string;
    /** 应用服务包ID */
    appServicePackId?: string;
    /** 应用级别 */
    applicationLevel?: EProcessBasicInformationRespondsToTheDTO_applicationLevel;
}

export enum EApplyBasicInformationToQueryObjects_applicationLevel {
    /** 项目管理 */
...
export enum EProcessBasicInformationRespondsToTheDTO_type {
    /** 单据 */
    BILL = "BILL",
    /** 基础数据 */
    DATA = "DATA",
...
export enum EProcessBasicInformationRespondsToTheDTO_isSystem {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessBasicInformationRespondsToTheDTO_flowPathSystemType {
    /** 仓库 */
...
export enum EProcessBasicInformationRespondsToTheDTO_isTree {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessBasicInformationRespondsToTheDTO_isMultiFlow {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessBasicInformationRespondsToTheDTO_flowPathResultNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessBasicInformationRespondsToTheDTO_recommitNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessBasicInformationRespondsToTheDTO_invalidNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessBasicInformationRespondsToTheDTO_deleteNotify {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum EProcessBasicInformationRespondsToTheDTO_applicationLevel {
    /** 项目管理 */
    PROJECT_MANAGER = "PROJECT_MANAGER",
    /** 企业 */
    ENTERPRISE = "ENTERPRISE"
