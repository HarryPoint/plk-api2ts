...
/**
* @author 
* @link http://47.108.135.148:16500/doc.html#/default/定制表单字段设置规则 - 相关/getByFormFunctionUsingGET
*/
export default function fetchMethod(options: { params: { formFunctionType?: EformFunctionType } }, extraOptions?: any) {
...
export interface ICustomizedFormFieldSettingRuleVO {
    ...
    id?: string;
    /** 表单功能 */
    formFunction?: ECustomizedFormFieldSettingRuleVO_formFunction;
    /** 定位类型 */
    fixType?: ECustomizedFormFieldSettingRuleVO_fixType;
    /** 定位序列 */
    fixSort?: number;
    /** 是否显示 */
    isShow?: ECustomizedFormFieldSettingRuleVO_isShow;
    /** 序列号 */
    serialNo?: string;
    /** 系统类型 */
    systemType?: ECustomizedFormFieldSettingRuleVO_systemType;
    /** 排序 */
    sort?: number;
}

export enum EformFunctionType {
    PRODUCE_STATISTICS = "PRODUCE_STATISTICS"
}

export enum ECustomizedFormFieldSettingRuleVO_formFunction {
    /** 生产统计 */
    PRODUCE_STATISTICS = "PRODUCE_STATISTICS"
}

export enum ECustomizedFormFieldSettingRuleVO_fixType {
    /** 左侧固定 */
    LEFT = "LEFT",
    /** 不固定 */
    NORMAL = "NORMAL",
...
export enum ECustomizedFormFieldSettingRuleVO_isShow {
    /** 是 */
    Y = "Y",
    /** 否 */
    N = "N"
...
export enum ECustomizedFormFieldSettingRuleVO_systemType {
    /** 仓库 */
