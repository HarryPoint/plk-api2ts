...
/**
* @author 
* @link http://47.108.135.148:16500/doc.html#/default/定制表单字段设置规则 - 相关/saveRuleForSystemBusinessTypeUsingPOST
*/
...
export interface IFlowTableLocateTheGroupFlowIdEditTheDTO {
    ...
    /** 系统类型 */
    systemType?: EFlowTableLocateTheGroupFlowIdEditTheDTO_systemType;
    /** 右侧固定表格列 */
    rightFixColumns?: IProcessTableColumnEditDTO[];
    /** 功能编码 */
    formFunction?: EFlowTableLocateTheGroupFlowIdEditTheDTO_formFunction;
}
/** 流程表格列编辑DTO */
...
export enum EFlowTableLocateTheGroupFlowIdEditTheDTO_systemType {
    /** 仓库 */
...
export enum EFlowTableLocateTheGroupFlowIdEditTheDTO_formFunction {
    /** 生产统计 */
